...
{
    public class StoreGeneratedActianTestGenerator : TestGenerator
    {
        public static void Generate()
        {
            new StoreGeneratedActianTestGenerator().GenerateFile();
        }

        private StoreGeneratedActianTestGenerator() : base()
        {
        }

        public override string[] EFPaths => new[]
        {
            Path.Combine(Paths.EFCoreSpecificationTests, "StoreGeneratedTestBase.cs")
        };
        public override string SqlServerPath => Path.Combine(Paths.EFCoreSqlServerFunctionalTests, "StoreGeneratedSqlServerTest.cs");
        public override string ActianPath => Path.Combine(Paths.ActianEFCoreFunctionalTests, "StoreGeneratedActianTest.cs");
        ...
        protected override void WriteClassInit(IndentedTextWriter writer)
        {
            writer.WriteText($@"
                ...
                {{
                    ...
                    TestEnvironment.LogTestClassImplements(testOutputHelper, typeof(StoreGeneratedTestBase<StoreGeneratedActianFixture>));
                }}
