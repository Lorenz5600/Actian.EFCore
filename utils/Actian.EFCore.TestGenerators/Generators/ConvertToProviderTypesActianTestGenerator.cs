...
{
    public class ConvertToProviderTypesActianTestGenerator : TestGenerator
    {
        public static void Generate()
        {
            new ConvertToProviderTypesActianTestGenerator().GenerateFile();
        }

        private ConvertToProviderTypesActianTestGenerator() : base()
        {
        }
        ...
        public override string[] EFPaths => new[]
        {
            ...
            Path.Combine(Paths.EFCoreSpecificationTests, "ConvertToProviderTypesTestBase.cs")
        };

        public override string SqlServerPath => Path.Combine(Paths.EFCoreSqlServerFunctionalTests, "ConvertToProviderTypesSqlServerTest.cs");
        public override string ActianPath => Path.Combine(Paths.ActianEFCoreFunctionalTests, "ConvertToProviderTypesActianTest.cs");
        ...
        {
            writer.WriteText(@"
                public class ConvertToProviderTypesActianTest : ConvertToProviderTypesTestBase<ConvertToProviderTypesActianTest.ConvertToProviderTypesActianFixture>
            ");
        }
        ...
        {
            writer.WriteText(@"
                public ConvertToProviderTypesActianTest(ConvertToProviderTypesActianFixture fixture)
                    : base(fixture)
                {
                }
        ...
        protected override void WriteClassFinit(IndentedTextWriter writer)
        {
            writer.WriteText(@"
                ...
                public class ConvertToProviderTypesActianFixture : ConvertToProviderTypesFixtureBase
                {
