...
namespace Actian.EFCore
{
        ...
        GraphUpdatesActianClientCascadeTest.ActianFixture>
    {
        ...
        public override void Reparent_dependent_one_to_many(
            ChangeMechanism changeMechanism,
            CascadeTiming? deleteOrphansTiming)
        {
            base.Reparent_dependent_one_to_many(changeMechanism, deleteOrphansTiming);
        }


        public override void Reparent_dependent_one_to_many_ak(
            ChangeMechanism changeMechanism,
            CascadeTiming? deleteOrphansTiming)
        {
            base.Reparent_dependent_one_to_many_ak(changeMechanism, deleteOrphansTiming);
        }
