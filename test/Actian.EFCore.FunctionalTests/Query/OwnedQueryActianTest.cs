...
{
    public class OwnedQueryActianTest : OwnedQueryRelationalTestBase<OwnedQueryActianTest.OwnedQueryActianFixture>
    {
...
""");
        ...
        public override async Task Navigation_rewrite_on_owned_collection_with_composition_complex(bool async)
        {
            ...
            AssertSql(
                """
SELECT (
    SELECT FIRST 1 "o1"."PersonAddress_Country_Name"
    FROM "Order" AS "o0"
...
""");
        ...
        public class OwnedQueryActianFixture : RelationalOwnedQueryFixture
        {
