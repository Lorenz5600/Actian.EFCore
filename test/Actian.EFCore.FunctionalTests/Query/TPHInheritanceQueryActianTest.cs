...
{
    public class TPHInheritanceQueryActianTest : TPHInheritanceQueryTestBase<TPHInheritanceQueryActianFixture>
    {
        public TPHInheritanceQueryActianTest(TPHInheritanceQueryActianFixture fixture, ITestOutputHelper testOutputHelper)
        ...
        public override async Task Can_query_when_shared_column(bool async)
        {
            ...
            AssertSql(
                """
SELECT FIRST 2 "d"."Id", "d"."Discriminator", "d"."SortIndex", "d"."CaffeineGrams", "d"."CokeCO2", "d"."SugarGrams"
FROM "Drinks" AS "d"
WHERE "d"."Discriminator" = 1
""",
                //
                """
SELECT FIRST 2 "d"."Id", "d"."Discriminator", "d"."SortIndex", "d"."LiltCO2", "d"."SugarGrams"
FROM "Drinks" AS "d"
WHERE "d"."Discriminator" = 2
""",
                //
                """
SELECT FIRST 2 "d"."Id", "d"."Discriminator", "d"."SortIndex", "d"."CaffeineGrams", "d"."HasMilk"
FROM "Drinks" AS "d"
...
""");
        ...
        public override async Task Can_query_just_kiwis(bool async)
        {
            ...
            AssertSql(
                """
SELECT FIRST 2 "a"."Id", "a"."CountryId", "a"."Discriminator", "a"."Name", "a"."Species", "a"."EagleId", "a"."IsFlightless", "a"."FoundOn"
FROM "Animals" AS "a"
WHERE "a"."Discriminator" = N'Kiwi'
""");
        }
        ...
        public override async Task Can_query_just_roses(bool async)
        {
            ...
            AssertSql(
                """
SELECT FIRST 2 "p"."Species", "p"."CountryId", "p"."Genus", "p"."Name", "p"."HasThorns"
FROM "Plants" AS "p"
WHERE "p"."Genus" = 0
""");
        }
...
SELECT "a"."Id", "a"."CountryId", "a"."Discriminator", "a"."Name", "a"."Species", "a"."EagleId", "a"."IsFlightless", "a"."FoundOn"
FROM "Animals" AS "a"
WHERE "a"."Discriminator" = N'Kiwi' AND "a"."FoundOn" = 0
""");
        }
...
SELECT "a"."Id", "a"."CountryId", "a"."Discriminator", "a"."Name", "a"."Species", "a"."EagleId", "a"."IsFlightless", "a"."FoundOn"
FROM "Animals" AS "a"
WHERE "a"."Discriminator" = N'Kiwi' AND "a"."FoundOn" = 1
""");
        }
...
FROM "Animals" AS "a"
WHERE (
    SELECT FIRST 1 "a0"."Discriminator"
    FROM "Animals" AS "a0"
...
""",
                ...
                """
@p0='0'
@p1='Eagle' (Nullable = false)
@p2='2' (Nullable = true)
@p3='1' (Nullable = true)
@p4='False' (Nullable = true)
@p5='Bald eagle'
@p6='Haliaeetus leucocephalus'
