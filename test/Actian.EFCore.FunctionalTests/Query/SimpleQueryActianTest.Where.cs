...
namespace Actian.EFCore.Query
{
    partial class SimpleQueryActianTest
    {
        ...
        public override Task Where_nested_field_access_closure_via_query_cache_error_null_async()
        {
            return base.Where_nested_field_access_closure_via_query_cache_error_null_async();
        }
        ...
        public override Task Where_nested_field_access_closure_via_query_cache_error_method_null_async()
        {
            return base.Where_nested_field_access_closure_via_query_cache_error_method_null_async();
        }
        ...
        public override Task Where_simple_shadow_projection_mixed(bool isAsync)
        {
            return base.Where_simple_shadow_projection_mixed(isAsync);
        }
        ...
        public override Task Where_client(bool isAsync)
        {
            return base.Where_client(isAsync);
        }
        ...
        public override Task Where_client_and_server_top_level(bool isAsync)
        {
            return base.Where_client_and_server_top_level(isAsync);
        }
        
        public override Task Where_client_or_server_top_level(bool isAsync)
        {
            return base.Where_client_or_server_top_level(isAsync);
        }
        
        public override Task Where_client_and_server_non_top_level(bool isAsync)
        {
            return base.Where_client_and_server_non_top_level(isAsync);
        }
        
        public override Task Where_client_deep_inside_predicate_and_server_top_level(bool isAsync)
        {
            return base.Where_client_deep_inside_predicate_and_server_top_level(isAsync);
        }
        ...
        [ActianTodo]
        public override Task Where_primitive_tracked(bool isAsync)
        {
            return base.Where_primitive_tracked(isAsync);
        }
        
        [ActianTodo]
        public override Task Where_primitive_tracked2(bool isAsync)
        {
            return base.Where_primitive_tracked2(isAsync);
        }
        ...
        public override Task Where_bool_closure(bool isAsync)
        {
            return base.Where_bool_closure(isAsync);
        }
        
        public override Task Where_poco_closure(bool isAsync)
        {
            return base.Where_poco_closure(isAsync);
        }
        ...
        public override Task Where_projection(bool isAsync)
        {
            return base.Where_projection(isAsync);
        }
        ...
        public override async Task Where_chain(bool isAsync)
        {
            ...
            AssertSql(@"
                SELECT ""o"".""OrderID"", ""o"".""CustomerID"", ""o"".""EmployeeID"", ""o"".""OrderDate""
                FROM ""Orders"" AS ""o""
                WHERE (""o"".""CustomerID"" = N'QUICK') AND (""o"".""OrderDate"" > TIMESTAMP '1998-01-01 00:00:00')
            ");
        }
        ...
        public override async Task Filter_non_nullable_value_after_FirstOrDefault_on_empty_collection(bool isAsync)
        {
            ...
            AssertSql(@"
                ...
                FROM ""Customers"" AS ""c""
                WHERE (
                    SELECT FIRST 1 CAST(LEN(""o"".""CustomerID"") AS int)
                    FROM ""Orders"" AS ""o""
        ...
        public override async Task Like_with_non_string_column_using_double_cast(bool isAsync)
        {
            ...
            AssertSql(@"
                SELECT ""o"".""OrderID"", ""o"".""CustomerID"", ""o"".""EmployeeID"", ""o"".""OrderDate""
                FROM ""Orders"" AS ""o""
                WHERE CAST(""o"".""OrderID"" AS long nvarchar) LIKE N'%20%'
            ");
        }
    }
}
