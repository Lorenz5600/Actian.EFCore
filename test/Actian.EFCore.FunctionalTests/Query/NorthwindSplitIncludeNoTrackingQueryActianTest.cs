...
public class NorthwindSplitIncludeNoTrackingQueryActianTest : NorthwindSplitIncludeNoTrackingQueryTestBase<
    NorthwindQueryActianFixture<NoopModelCustomizer>>
{
    public NorthwindSplitIncludeNoTrackingQueryActianTest(
