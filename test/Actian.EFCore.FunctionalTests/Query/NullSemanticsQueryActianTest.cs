    ...
    public class NullSemanticsQueryActianTest : NullSemanticsQueryTestBase<NullSemanticsQueryActianFixture>
    {
        ...
        public override void Compare_complex_equal_equal_equal()
        {
            ...
            AssertSql(
                @"
                    ...
                    FROM ""Entities1"" AS ""e""
                    WHERE CASE
                        WHEN ""e"".""BoolA"" = ""e"".""BoolB"" THEN TRUE
                        ELSE FALSE
                    END = CASE
                        WHEN ""e"".""IntA"" = ""e"".""IntB"" THEN TRUE
                        ELSE FALSE
                    END
                ",
                @"
                    ...
                    FROM ""Entities1"" AS ""e""
                    WHERE CASE
                        WHEN (""e"".""NullableBoolA"" = ""e"".""BoolB"") AND ""e"".""NullableBoolA"" IS NOT NULL THEN TRUE
                        ELSE FALSE
                    END = CASE
                        WHEN (""e"".""IntA"" = ""e"".""NullableIntB"") AND ""e"".""NullableIntB"" IS NOT NULL THEN TRUE
                        ELSE FALSE
                    END
                ",
                @"
                    ...
                    FROM ""Entities1"" AS ""e""
                    WHERE CASE
                        WHEN ((""e"".""NullableBoolA"" = ""e"".""NullableBoolB"") AND (""e"".""NullableBoolA"" IS NOT NULL AND ""e"".""NullableBoolB"" IS NOT NULL)) OR (""e"".""NullableBoolA"" IS NULL AND ""e"".""NullableBoolB"" IS NULL) THEN TRUE
                        ELSE FALSE
                    END = CASE
                        WHEN ((""e"".""NullableIntA"" = ""e"".""NullableIntB"") AND (""e"".""NullableIntA"" IS NOT NULL AND ""e"".""NullableIntB"" IS NOT NULL)) OR (""e"".""NullableIntA"" IS NULL AND ""e"".""NullableIntB"" IS NULL) THEN TRUE
                        ELSE FALSE
                    END
                "
            );
        ...
        public override void Compare_complex_not_equal_equal_equal()
        {
            ...
            AssertSql(
                ...
                @"
                    ...
                    FROM ""Entities1"" AS ""e""
                    WHERE CASE
                        WHEN (""e"".""NullableBoolA"" <> ""e"".""BoolB"") OR ""e"".""NullableBoolA"" IS NULL THEN TRUE
                        ELSE FALSE
                    END = CASE
                        WHEN (""e"".""IntA"" = ""e"".""NullableIntB"") AND ""e"".""NullableIntB"" IS NOT NULL THEN TRUE
                        ELSE FALSE
                ...
                @"
                    ...
                    FROM ""Entities1"" AS ""e""
                    WHERE CASE
                        WHEN ((""e"".""NullableBoolA"" <> ""e"".""NullableBoolB"") OR (""e"".""NullableBoolA"" IS NULL OR ""e"".""NullableBoolB"" IS NULL)) AND (""e"".""NullableBoolA"" IS NOT NULL OR ""e"".""NullableBoolB"" IS NOT NULL) THEN TRUE
                        ELSE FALSE
                    END = CASE
                        WHEN ((""e"".""NullableIntA"" = ""e"".""NullableIntB"") AND (""e"".""NullableIntA"" IS NOT NULL AND ""e"".""NullableIntB"" IS NOT NULL)) OR (""e"".""NullableIntA"" IS NULL AND ""e"".""NullableIntB"" IS NULL) THEN TRUE
                        ELSE FALSE
            ...
            AssertSql(
                ...
                @"
                    ...
                    WHERE CASE
                        ...
                        ELSE FALSE
                    END = CASE
                        WHEN (""e"".""IntA"" <> ""e"".""NullableIntB"") OR ""e"".""NullableIntB"" IS NULL THEN TRUE
                        ELSE FALSE
                    END
                ",
                @"
                    ...
                    WHERE CASE
                        ...
                        ELSE FALSE
                    END = CASE
                        WHEN ((""e"".""NullableIntA"" <> ""e"".""NullableIntB"") OR (""e"".""NullableIntA"" IS NULL OR ""e"".""NullableIntB"" IS NULL)) AND (""e"".""NullableIntA"" IS NOT NULL OR ""e"".""NullableIntB"" IS NOT NULL) THEN TRUE
                        ELSE FALSE
                    END
                "
            );
        ...
        public override void Where_coalesce()
        {
            ...
            AssertSql(@"
                SELECT ""e"".""Id""
                FROM ""Entities1"" AS ""e""
                WHERE COALESCE(""e"".""NullableBoolA"", TRUE) = TRUE
            ");
        }
        ...
        public override void Where_equal_with_and_and_contains()
        {
            ...
            AssertSql(@"
                SELECT ""e"".""Id""
                FROM ""Entities1"" AS ""e""
                WHERE (POSITION(""e"".""NullableStringB"", ""e"".""NullableStringA"") > 0) AND (""e"".""BoolA"" = TRUE)
            ");
        }
        ...
        public override void Null_comparison_in_selector_with_relational_nulls()
        {
            ...
            AssertSql(@"
                SELECT CASE
                    WHEN ""e"".""NullableStringA"" <> N'Foo' THEN TRUE
                    ELSE FALSE
                END
                FROM ""Entities1"" AS ""e""
            ");
        ...
        public override void Null_comparison_in_order_by_with_relational_nulls()
        {
            ...
            AssertSql(@"
                ...
                ORDER BY CASE
                    ...
                    ELSE FALSE
                END, CASE
                    WHEN ""e"".""NullableIntB"" <> 10 THEN TRUE
                    ELSE FALSE
                END
            ");
        }
        ...
        public override void Projecting_nullable_bool_with_coalesce_nested()
        {
            ...
            AssertSql(@"
                SELECT ""e"".""Id"", COALESCE(""e"".""NullableBoolA"", COALESCE(""e"".""NullableBoolB"", FALSE)) AS ""Coalesce""
                FROM ""Entities1"" AS ""e""
            ");
        }
            ...
            AssertSql(
                ...
                @"
                    ...
                    WHERE CASE
                        ...
                        ELSE CASE
                            WHEN ((""e"".""NullableBoolB"" = ""e"".""NullableBoolC"") AND (""e"".""NullableBoolB"" IS NOT NULL AND ""e"".""NullableBoolC"" IS NOT NULL)) OR (""e"".""NullableBoolB"" IS NULL AND ""e"".""NullableBoolC"" IS NULL) THEN TRUE
                            ELSE FALSE
                        END
                    END = TRUE
                "
