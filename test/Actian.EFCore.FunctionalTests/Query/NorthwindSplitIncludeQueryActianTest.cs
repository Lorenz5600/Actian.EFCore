...
public class NorthwindSplitIncludeQueryActianTest : NorthwindSplitIncludeQueryTestBase<
    NorthwindQueryActianFixture<NoopModelCustomizer>>
{
    public NorthwindSplitIncludeQueryActianTest(
...
FROM "Products" AS "p"
WHERE (mod("p"."ProductID", 17)) = 5 AND "p"."UnitPrice" < 20.0
...
FROM (
    SELECT FIRST 1 "c"."CustomerID", "c"."CompanyName"
    FROM "Customers" AS "c"
...
""");
    ...
    public override async Task Include_collection_skip_no_order_by(bool async)
        => Assert.Equal(
            ActianStrings.SplitQueryOffsetWithoutOrderBy,
...
INNER JOIN "Orders" AS "o0" ON "o"."OrderID" = "o0"."OrderID"
LEFT JOIN "Customers" AS "c" ON "o0"."CustomerID" = "c"."CustomerID"
WHERE (mod("o"."OrderID", 23)) = 13 AND "o"."UnitPrice" < 10.0
...
""");
    ...
    public override async Task Include_multi_level_reference_and_collection_predicate(bool async)
    {
        ...
        AssertSql(
            """
SELECT FIRST 2 "o"."OrderID", "o"."CustomerID", "o"."EmployeeID", "o"."OrderDate", "c"."CustomerID", "c"."Address", "c"."City", "c"."CompanyName", "c"."ContactName", "c"."ContactTitle", "c"."Country", "c"."Fax", "c"."Phone", "c"."PostalCode", "c"."Region"
FROM "Orders" AS "o"
LEFT JOIN "Customers" AS "c" ON "o"."CustomerID" = "c"."CustomerID"
...
""",
            //
            """
SELECT "o0"."OrderID", "o0"."CustomerID", "o0"."EmployeeID", "o0"."OrderDate", "t"."OrderID", "t"."CustomerID"
FROM (
    SELECT FIRST 1 "o"."OrderID", "c"."CustomerID"
    FROM "Orders" AS "o"
    LEFT JOIN "Customers" AS "c" ON "o"."CustomerID" = "c"."CustomerID"
    WHERE "o"."OrderID" = 10248
) AS "t"
...
SELECT "t0"."CustomerID", "t0"."Address", "t0"."City", "t0"."CompanyName", "t0"."ContactName", "t0"."ContactTitle", "t0"."Country", "t0"."Fax", "t0"."Phone", "t0"."PostalCode", "t0"."Region", "t"."CustomerID"
FROM (
    SELECT TOP(@__p_0) "c"."CustomerID"
    FROM "Customers" AS "c"
    ORDER BY "c"."CustomerID"
...
""");
    ...
    public override async Task Include_empty_reference_sets_IsLoaded(bool async)
    {
        ...
        AssertSql(
            """
SELECT FIRST 1 "e"."EmployeeID", "e"."City", "e"."Country", "e"."FirstName", "e"."ReportsTo", "e"."Title", "e0"."EmployeeID", "e0"."City", "e0"."Country", "e0"."FirstName", "e0"."ReportsTo", "e0"."Title"
FROM "Employees" AS "e"
LEFT JOIN "Employees" AS "e0" ON "e"."ReportsTo" = "e0"."EmployeeID"
...
INNER JOIN "Orders" AS "o0" ON "o"."OrderID" = "o0"."OrderID"
LEFT JOIN "Customers" AS "c" ON "o0"."CustomerID" = "c"."CustomerID"
WHERE (mod("o"."ProductID", 23)) = 17 AND "o"."Quantity" < 10
ORDER BY "o"."OrderID", "o"."ProductID", "o0"."OrderID", "c"."CustomerID"
""",
            //
            """
