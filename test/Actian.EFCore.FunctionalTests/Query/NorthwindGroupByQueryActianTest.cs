...
public class NorthwindGroupByQueryActianTest : NorthwindGroupByQueryRelationalTestBase<
    NorthwindQueryActianFixture<NoopModelCustomizer>>
{
    public NorthwindGroupByQueryActianTest(
...
""");
    ...
    public override async Task GroupBy_Dto_as_element_selector_Select_Sum(bool async)
    {
        ...
        AssertSql(
            """
SELECT COALESCE(SUM(CAST("o"."EmployeeID" AS bigint)), 0) AS "Sum", "o"."CustomerID" AS "Key"
FROM "Orders" AS "o"
GROUP BY "o"."CustomerID"
""");
    }
...
""");
    ...
    public override async Task GroupBy_Select_Distinct_aggregate(bool async)
    {
        ...
        AssertSql(
            """
SELECT "o"."CustomerID" AS "Key", AVG(DISTINCT (CAST("o"."OrderID" AS float))) AS "Average", COUNT(DISTINCT ("o"."EmployeeID")) AS "Count", COUNT(DISTINCT ("o"."EmployeeID")) AS "LongCount", MAX(DISTINCT ("o"."OrderDate")) AS "Max", MIN(DISTINCT ("o"."OrderDate")) AS "Min", COALESCE(SUM(DISTINCT ("o"."OrderID")), 0) AS "Sum"
FROM "Orders" AS "o"
GROUP BY "o"."CustomerID"
""");
    }
...
""");
    ...
    public override async Task GroupBy_with_cast_inside_grouping_aggregate(bool async)
    {
        ...
        AssertSql(
            """
SELECT "o"."CustomerID" AS "Key", COUNT(*) AS "Count", COALESCE(SUM(CAST("o"."OrderID" AS bigint)), 0) AS "Sum"
FROM "Orders" AS "o"
GROUP BY "o"."CustomerID"
""");
    }
...
OUTER APPLY (
    SELECT FIRST 1 "e"."City" AS "Key", COUNT(*) + (
        SELECT COUNT(*)
        FROM "Orders" AS "o0"
...
SELECT "o"."CustomerID" AS "Key", COALESCE((
    SELECT FIRST 1 COUNT(*) + MIN("o"."OrderID")
    FROM "Employees" AS "e"
    WHERE "e"."City" = N'Seattle'
    GROUP BY "e"."City"
