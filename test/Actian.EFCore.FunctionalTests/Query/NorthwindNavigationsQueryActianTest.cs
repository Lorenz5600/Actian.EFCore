...
public class NorthwindNavigationsQueryActianTest : NorthwindNavigationsQueryRelationalTestBase<
    NorthwindQueryActianFixture<NoopModelCustomizer>>
{
    public NorthwindNavigationsQueryActianTest(
...
""");
    ...
    public override async Task Select_count_plus_sum(bool async)
    {
        ...
        AssertSql(
            """
SELECT (
    SELECT COALESCE(SUM(CAST("o0"."Quantity" AS integer)), 0)
