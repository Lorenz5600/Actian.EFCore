...
public class NorthwindWhereQueryActianTest : NorthwindWhereQueryRelationalTestBase<
    NorthwindQueryActianFixture<NoopModelCustomizer>>
{
    public NorthwindWhereQueryActianTest(
...
SELECT "o"."CustomerID"
FROM "Orders" AS "o"
WHERE (CAST("o"."OrderID" AS long nvarchar) + COALESCE("o"."CustomerID", N'')) = "o"."CustomerID"
""");
    }
...
SELECT "p"."ProductID", "p"."Discontinued", "p"."ProductName", "p"."SupplierID", "p"."UnitPrice", "p"."UnitsInStock"
FROM "Products" AS "p"
WHERE CAST("p"."UnitPrice" AS float) > 100.0
""");
    }
