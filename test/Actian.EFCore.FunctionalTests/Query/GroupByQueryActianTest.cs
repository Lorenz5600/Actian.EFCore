...
{
    public class GroupByQueryActianTest : GroupByQueryTestBase<NorthwindQueryActianFixture<NoopModelCustomizer>>
    {
        public GroupByQueryActianTest(NorthwindQueryActianFixture<NoopModelCustomizer> fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
        ...
        public override async Task GroupBy_with_grouping_key_using_Like(bool isAsync)
        {
            ...
            AssertSql(@"
                SELECT CASE
                    WHEN ""o"".""CustomerID"" LIKE N'A%' THEN TRUE
                    ELSE FALSE
        ...
        public override async Task GroupJoin_complex_GroupBy_Aggregate(bool isAsync)
        {
            ...
            AssertSql(@"
                ...
                INNER JOIN (
                    SELECT FIRST @__p_2 ""o"".""OrderID"", ""o"".""CustomerID"", ""o"".""EmployeeID"", ""o"".""OrderDate""
                    FROM ""Orders"" AS ""o""
                    WHERE ""o"".""OrderID"" < 10400
                    ORDER BY ""o"".""OrderDate""
                ) AS ""t0"" ON ""t"".""CustomerID"" = ""t0"".""CustomerID""
        ...
        public override async Task Join_GroupBy_entity_ToList(bool isAsync)
        {
            ...
            AssertSql(@"
                ...
                INNER JOIN (
                    SELECT FIRST @__p_1 ""o0"".""OrderID"", ""o0"".""CustomerID"", ""o0"".""EmployeeID"", ""o0"".""OrderDate""
                    FROM ""Orders"" AS ""o0""
                    ORDER BY ""o0"".""OrderID""
