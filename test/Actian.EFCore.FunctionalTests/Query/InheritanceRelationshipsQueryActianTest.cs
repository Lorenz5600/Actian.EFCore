...
{
    public class InheritanceRelationshipsQueryActianTest
        : InheritanceRelationshipsQueryRelationalTestBase<
            InheritanceRelationshipsQueryActianTest.InheritanceRelationshipsQueryActianFixture>
    {
        public InheritanceRelationshipsQueryActianTest(
            InheritanceRelationshipsQueryActianFixture fixture,
...
""");
        ...
        public override async Task Include_collection_with_inheritance_on_derived_reverse_split(bool async)
        {
            ...
            AssertSql(
                """
SELECT "b"."Id", "b"."Discriminator", "b"."Name", "b"."ParentId", "b"."DerivedInheritanceRelationshipEntityId", "t"."Id", "t"."Discriminator", "t"."Name", "t"."BaseId", "t"."OwnedReferenceOnBase_Id", "t"."OwnedReferenceOnBase_Name", "t"."OwnedReferenceOnDerived_Id", "t"."OwnedReferenceOnDerived_Name"
FROM "BaseCollectionsOnDerived" AS "b"
LEFT JOIN (
    SELECT "b0"."Id", "b0"."Discriminator", "b0"."Name", "b0"."BaseId", "b0"."OwnedReferenceOnBase_Id", "b0"."OwnedReferenceOnBase_Name", "b0"."OwnedReferenceOnDerived_Id", "b0"."OwnedReferenceOnDerived_Name"
    FROM "BaseEntities" AS "b0"
...
FROM (
    SELECT FIRST 2 "b"."Id", "b"."Discriminator", "b"."Name", "b"."BaseId", "b"."OwnedReferenceOnBase_Id", "b"."OwnedReferenceOnBase_Name", "b"."OwnedReferenceOnDerived_Id", "b"."OwnedReferenceOnDerived_Name"
    FROM "BaseEntities" AS "b"
...
""");
        ...
        public class InheritanceRelationshipsQueryActianFixture : InheritanceRelationshipsQueryRelationalFixture
        {
