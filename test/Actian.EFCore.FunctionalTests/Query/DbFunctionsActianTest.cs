...
{
    public class DbFunctionsActianTest : NorthwindDbFunctionsQueryRelationalTestBase<NorthwindQueryActianFixture<NoopModelCustomizer>>
    {
...
""");
        ...
        [ConditionalFact]
        [TestUtilities.ActianCondition(ActianCondition.SupportsFullTextSearch)]
...
""");
        ...
        public void FreeText_with_language_term()
        {
            ...
            AssertSql(
                """
SELECT FIRST 2 "e"."EmployeeID", "e"."City", "e"."Country", "e"."FirstName", "e"."ReportsTo", "e"."Title"
FROM "Employees" AS "e"
...
""");
        ...
        public void FreeText_multiple_predicates()
        {
            ...
            AssertSql(
                """
SELECT FIRST 1 "e"."EmployeeID", "e"."City", "e"."Country", "e"."FirstName", "e"."ReportsTo", "e"."Title"
FROM "Employees" AS "e"
...
""");
        ...
        public void Contains_should_throw_on_client_eval()
        {
            ...
            Assert.Equal(
                CoreStrings.FunctionOnClient(nameof(ActianDbFunctionsExtensions.Contains)),
                exNoLang.Message);
...
""");
        ...
        public void IsDate_should_throw_on_client_eval()
        {
            ...
            Assert.Equal(
                CoreStrings.FunctionOnClient(nameof(ActianDbFunctionsExtensions.IsDate)),
                exIsDate.Message);
        }
...
""");
        ...
        public void IsNumeric_should_throw_on_client_eval()
        {
            ...
            Assert.Equal(
                CoreStrings.FunctionOnClient(nameof(ActianDbFunctionsExtensions.IsNumeric)),
                exIsDate.Message);
        }
