...
namespace Actian.EFCore.Query
{
    public class InheritanceActianTest : InheritanceRelationalTestBase<InheritanceActianFixture>
    {
        ...
        public override void Can_query_when_shared_column()
        {
            ...
            AssertSql(
                @"
                    SELECT FIRST 2 ""d"".""Id"", ""d"".""Discriminator"", ""d"".""CaffeineGrams"", ""d"".""CokeCO2"", ""d"".""SugarGrams""
                    FROM ""Drink"" AS ""d""
                    WHERE ""d"".""Discriminator"" = N'Coke'
                ",
                @"
                    SELECT FIRST 2 ""d"".""Id"", ""d"".""Discriminator"", ""d"".""LiltCO2"", ""d"".""SugarGrams""
                    FROM ""Drink"" AS ""d""
                    WHERE ""d"".""Discriminator"" = N'Lilt'
                ",
                @"
                    SELECT FIRST 2 ""d"".""Id"", ""d"".""Discriminator"", ""d"".""CaffeineGrams"", ""d"".""HasMilk""
                    FROM ""Drink"" AS ""d""
        ...
        public override void Can_query_just_kiwis()
        {
            ...
            AssertSql(@"
                SELECT FIRST 2 ""a"".""Species"", ""a"".""CountryId"", ""a"".""Discriminator"", ""a"".""Name"", ""a"".""EagleId"", ""a"".""IsFlightless"", ""a"".""FoundOn""
                FROM ""Animal"" AS ""a""
        ...
        public override void Can_include_prey()
        {
            ...
            AssertSql(@"
                ...
                FROM (
                    SELECT FIRST 2 ""a"".""Species"", ""a"".""CountryId"", ""a"".""Discriminator"", ""a"".""Name"", ""a"".""EagleId"", ""a"".""IsFlightless"", ""a"".""Group""
                    FROM ""Animal"" AS ""a""
        ...
        public override void Subquery_OfType()
        {
            ...
            AssertSql(@"
                ...
                FROM (
                    SELECT FIRST @__p_0 ""a"".""Species"", ""a"".""CountryId"", ""a"".""Discriminator"", ""a"".""Name"", ""a"".""EagleId"", ""a"".""IsFlightless"", ""a"".""Group"", ""a"".""FoundOn""
                    FROM ""Animal"" AS ""a""
                    WHERE ""a"".""Discriminator"" IN (N'Eagle', N'Kiwi')
                ) AS ""t""
        ...
        public override void Byte_enum_value_constant_used_in_projection()
        {
            ...
            AssertSql(@"
                SELECT CASE
                    WHEN ""a"".""IsFlightless"" = TRUE THEN CAST(0 AS tinyint)
