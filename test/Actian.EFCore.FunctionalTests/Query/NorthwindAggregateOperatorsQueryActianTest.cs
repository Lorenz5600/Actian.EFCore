...
public class NorthwindAggregateOperatorsQueryActianTest : NorthwindAggregateOperatorsQueryRelationalTestBase<
    NorthwindQueryActianFixture<NoopModelCustomizer>>
{
    public NorthwindAggregateOperatorsQueryActianTest(
...
""");
    ...
    public override async Task Sum_on_float_column(bool async)
    {
        ...
        AssertSql(
            """
SELECT CAST(COALESCE(SUM("o"."Discount"), 0.0) AS real)
FROM "Order Details" AS "o"
WHERE "o"."ProductID" = 1
""");
    }
    ...
    public override async Task Sum_on_float_column_in_subquery(bool async)
    {
        ...
        AssertSql(
            """
SELECT "o"."OrderID", (
    SELECT CAST(COALESCE(SUM("o0"."Discount"), 0.0) AS real)
    FROM "Order Details" AS "o0"
...
""");
    ...
    public override async Task Sum_over_explicit_cast_over_column(bool async)
    {
        ...
        AssertSql(
            """
SELECT COALESCE(SUM(CAST("o"."OrderID" AS bigint)), 0)
FROM "Orders" AS "o"
""");
    }
