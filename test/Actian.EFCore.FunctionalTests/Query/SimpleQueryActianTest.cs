...
namespace Actian.EFCore.Query
{
    ...
    {
        public override Task All_client(bool isAsync)
        {
            return base.All_client(isAsync);
        }

        public override Task All_client_and_server_top_level(bool isAsync)
        {
            return base.All_client_and_server_top_level(isAsync);
        }

        public override Task All_client_or_server_top_level(bool isAsync)
        {
            return base.All_client_or_server_top_level(isAsync);
        }
            ...
            AssertSql(@"
                SELECT CASE
                    WHEN NOT EXISTS (
                        SELECT 1
                        FROM ""Customers"" AS ""c""
                        WHERE ""c"".""ContactName"" IS NULL OR NOT (""c"".""ContactName"" LIKE N'A%')) THEN TRUE
                    ELSE FALSE
                END
            ");
        }
            ...
            AssertSql(@"
                SELECT CASE
                    WHEN NOT EXISTS (
                        SELECT 1
                        FROM ""Customers"" AS ""c""
                        WHERE ((""c"".""ContactName"" <> N'') OR ""c"".""ContactName"" IS NULL) AND (""c"".""ContactName"" IS NULL OR (""c"".""ContactName"" IS NULL OR ((LEFT(""c"".""ContactName"", LENGTH(""c"".""ContactName"")) <> ""c"".""ContactName"") OR LEFT(""c"".""ContactName"", LENGTH(""c"".""ContactName"")) IS NULL)))) THEN TRUE
                    ELSE FALSE
                END
            ");
        }
        ...
        [ActianSkip(@"
            Concatenating `""c"".""CustomerID""` (`nchar(5)`) and `""c"".""City""` (`nvarchar(15)`) in ActianX results in a fixed length string.
            ...
            AssertSql(@"
                SELECT CASE
                    WHEN EXISTS (
                        SELECT 1
                        FROM ""Customers"" AS ""c""
                        WHERE ""c"".""ContactName"" IS NOT NULL AND (""c"".""ContactName"" LIKE N'A%')) THEN TRUE
                    ELSE FALSE
                END
            ");
        }
        ...
        public override async Task AsQueryable_in_query_server_evals(bool isAsync)
        {
            ...
            AssertSql(@"
                ...
                FROM ""Customers"" AS ""c""
                OUTER APPLY (
                    SELECT FIRST 1 ""o"".""OrderDate"", ""o"".""OrderID""
                    FROM ""Orders"" AS ""o""
        ...
        public override Task Cast_results_to_object(bool isAsync)
        {
            return base.Cast_results_to_object(isAsync);
        }
        ...
        [ActianTodo]
        public override Task Client_where_GroupBy_Group_ordering_works(bool isAsync)
        {
            return base.Client_where_GroupBy_Group_ordering_works(isAsync);
        }

        [ActianTodo]
        public override Task Client_where_GroupBy_Group_ordering_works_2(bool isAsync)
        {
            return base.Client_where_GroupBy_Group_ordering_works_2(isAsync);
        }
        ...
        [ActianTodo("IngresException : The supplied object handle does not refer to a QSF object.")]
        public override async Task Comparing_to_fixed_string_parameter(bool isAsync)
        {
            ...
            AssertSql(@"
                ...
                SELECT ""c"".""CustomerID""
                FROM ""Customers"" AS ""c""
                WHERE (@__prefix_0 = N'') OR (LEFT(""c"".""CustomerID"", LENGTH(@__prefix_0)) = @__prefix_0)
            ");
        }

        [ActianTodo("IngresException : Invalid qualifier 't'. 't' must be declared in the FROM clause or equivalent. If used in a target list, 't' must be declared at the current scope.")]
                ...
                WHERE (""c"".""CustomerID"" = N'ALFKI') AND EXISTS (
                    ...
                    WHERE EXISTS (
                        ...
                        WHERE EXISTS (
                            SELECT DISTINCT 1
                            FROM (
                                SELECT FIRST 10 ""c2"".""CustomerID"", ""c2"".""Address"", ""c2"".""City"", ""c2"".""CompanyName"", ""c2"".""ContactName"", ""c2"".""ContactTitle"", ""c2"".""Country"", ""c2"".""Fax"", ""c2"".""Phone"", ""c2"".""PostalCode"", ""c2"".""Region""
        ...
        public override async Task DateTime_parse_is_inlined(bool isAsync)
        {
            ...
            AssertSql(@"
                SELECT ""o"".""OrderID"", ""o"".""CustomerID"", ""o"".""EmployeeID"", ""o"".""OrderDate""
                FROM ""Orders"" AS ""o""
                WHERE ""o"".""OrderDate"" > TIMESTAMP '1998-01-01 12:00:00'
            ");
        }
        ...
        {
            return base.Default_if_empty_top_level_arg(isAsync);
        }
        ...
        public override async Task Distinct_Take(bool isAsync)
        {
            ...
            AssertSql(@"
                ...
                SELECT FIRST @__p_0 ""t"".""OrderID"", ""t"".""CustomerID"", ""t"".""EmployeeID"", ""t"".""OrderDate""
                FROM (
        ...
        public override async Task Distinct_Take_Count(bool isAsync)
        {
            ...
            AssertSql(@"
                ...
                SELECT COUNT(*)
                FROM (
                    SELECT DISTINCT FIRST @__p_0 ""o"".""OrderID"", ""o"".""CustomerID"", ""o"".""EmployeeID"", ""o"".""OrderDate""
                    FROM ""Orders"" AS ""o""
                ) AS ""t""
            ");
        }
        ...
        public override async Task Environment_newline_is_funcletized(bool isAsync)
        {
            ...
            AssertSql(@"
                ...
                SELECT ""c"".""CustomerID"", ""c"".""Address"", ""c"".""City"", ""c"".""CompanyName"", ""c"".""ContactName"", ""c"".""ContactTitle"", ""c"".""Country"", ""c"".""Fax"", ""c"".""Phone"", ""c"".""PostalCode"", ""c"".""Region""
                FROM ""Customers"" AS ""c""
                WHERE POSITION(@__NewLine_0, ""c"".""CustomerID"") > 0
            ");
        }
        ...
        public override Task First_client_predicate(bool isAsync)
        {
            return base.First_client_predicate(isAsync);
        }
        ...
        public override async Task Join_take_count_works(bool isAsync)
        {
            ...
            AssertSql(@"
                ...
                SELECT COUNT(*)
                FROM (
                    SELECT FIRST @__p_0 ""o"".""OrderID"", ""o"".""CustomerID"", ""o"".""EmployeeID"", ""o"".""OrderDate"", ""t"".""CustomerID"" AS ""CustomerID0""
                    FROM ""Orders"" AS ""o""
                    INNER JOIN (
                        SELECT ""c"".""CustomerID"", ""c"".""Address"", ""c"".""City"", ""c"".""CompanyName"", ""c"".""ContactName"", ""c"".""ContactTitle"", ""c"".""Country"", ""c"".""Fax"", ""c"".""Phone"", ""c"".""PostalCode"", ""c"".""Region""
                        FROM ""Customers"" AS ""c""
            ...
            AssertSql(@"
                ...
                INNER JOIN (
                    ...
                    LEFT JOIN (
                        ...
                        WHERE ""e0"".""EmployeeID"" = 4294967295
                    ) AS ""t0"" ON 1 = 1
            ...
            AssertSql(@"
                SELECT CASE
                    WHEN EXISTS (
                        ...
                        WHERE ""c"".""City"" = N'London') THEN TRUE
                    ELSE FALSE
                END
            ");
        }
        ...
        public override Task Null_parameter_name_works(bool isAsync)
        {
            return base.Null_parameter_name_works(isAsync);
        }
        ...
        [ActianTodo]
        public override Task OrderByDescending(bool isAsync)
        {
            return base.OrderByDescending(isAsync);
        }
        ...
        [ActianTodo("IngresException : An internal error prevents further processing of this query.")]
        ...
        public override Task OrderBy_client_mixed(bool isAsync)
        {
            return base.OrderBy_client_mixed(isAsync);
        }
        ...
        public override async Task OrderBy_coalesce_skip_take_distinct_take(bool isAsync)
        {
            ...
            AssertSql(@"
                ...
                SELECT DISTINCT FIRST @__p_0 ""t"".""ProductID"", ""t"".""Discontinued"", ""t"".""ProductName"", ""t"".""SupplierID"", ""t"".""UnitPrice"", ""t"".""UnitsInStock""
                FROM (
                    SELECT ""p"".""ProductID"", ""p"".""Discontinued"", ""p"".""ProductName"", ""p"".""SupplierID"", ""p"".""UnitPrice"", ""p"".""UnitsInStock"", COALESCE(""p"".""UnitPrice"", 0.0) AS ""c""
                    FROM ""Products"" AS ""p""
                    ORDER BY COALESCE(""p"".""UnitPrice"", 0.0)
        ...
        public override async Task OrderBy_coalesce_take_distinct(bool isAsync)
        {
            ...
            AssertSql(@"
                ...
                SELECT DISTINCT ""t"".""ProductID"", ""t"".""Discontinued"", ""t"".""ProductName"", ""t"".""SupplierID"", ""t"".""UnitPrice"", ""t"".""UnitsInStock""
                FROM (
                    SELECT FIRST @__p_0 ""p"".""ProductID"", ""p"".""Discontinued"", ""p"".""ProductName"", ""p"".""SupplierID"", ""p"".""UnitPrice"", ""p"".""UnitsInStock"", COALESCE(""p"".""UnitPrice"", 0.0) AS ""c""
                    FROM ""Products"" AS ""p""
                    ORDER BY COALESCE(""p"".""UnitPrice"", 0.0)
                ) AS ""t""
            ");
        ...
        public override async Task OrderBy_comparison_operator(bool isAsync)
        {
            ...
            AssertSql(@"
                ...
                FROM ""Customers"" AS ""c""
                ORDER BY CASE
                    WHEN (""c"".""Region"" = N'ASK') AND ""c"".""Region"" IS NOT NULL THEN TRUE
                    ELSE FALSE
                END
            ");
        }
        ...
        [ActianTodo("IngresException : Server aborted connection.")]
        ...
        public override async Task OrderBy_correlated_subquery2(bool isAsync)
        {
            ...
            AssertSql(@"
                ...
                WHERE (""o"".""OrderID"" <= 10250) AND (((
                    SELECT FIRST 1 ""c"".""City""
                    FROM ""Customers"" AS ""c""
                    ORDER BY CASE
                        WHEN EXISTS (
                            SELECT 1
                            FROM ""Customers"" AS ""c0""
                            WHERE ""c0"".""CustomerID"" = N'ALFKI') THEN TRUE
                        ELSE FALSE
                    END) <> N'Nowhere') OR (
                    SELECT FIRST 1 ""c"".""City""
                    FROM ""Customers"" AS ""c""
        ...
        public override Task OrderBy_scalar_primitive(bool isAsync)
        {
            return base.OrderBy_scalar_primitive(isAsync);
        }

        [ActianTodo]
        public override Task OrderBy_Select(bool isAsync)
        {
            return base.OrderBy_Select(isAsync);
        }
        ...
        public override async Task OrderBy_SelectMany(bool isAsync)
        {
            ...
            AssertSql(@"
                ...
                FROM ""Customers"" AS ""c""
                CROSS JOIN (
                    SELECT FIRST 3 ""o"".""OrderID"", ""o"".""CustomerID"", ""o"".""EmployeeID"", ""o"".""OrderDate""
                    FROM ""Orders"" AS ""o""
                    ORDER BY ""o"".""OrderID""
                ) AS ""t""
        ...
        public override async Task OrderBy_skip_take_distinct_orderby_take(bool isAsync)
        {
            ...
            AssertSql(@"
                ...
                SELECT FIRST @__p_2 ""t0"".""CustomerID"", ""t0"".""Address"", ""t0"".""City"", ""t0"".""CompanyName"", ""t0"".""ContactName"", ""t0"".""ContactTitle"", ""t0"".""Country"", ""t0"".""Fax"", ""t0"".""Phone"", ""t0"".""PostalCode"", ""t0"".""Region""
                FROM (
                    SELECT DISTINCT ""t"".""CustomerID"", ""t"".""Address"", ""t"".""City"", ""t"".""CompanyName"", ""t"".""ContactName"", ""t"".""ContactTitle"", ""t"".""Country"", ""t"".""Fax"", ""t"".""Phone"", ""t"".""PostalCode"", ""t"".""Region""
                    FROM (
                        SELECT ""c"".""CustomerID"", ""c"".""Address"", ""c"".""City"", ""c"".""CompanyName"", ""c"".""ContactName"", ""c"".""ContactTitle"", ""c"".""Country"", ""c"".""Fax"", ""c"".""Phone"", ""c"".""PostalCode"", ""c"".""Region""
        ...
        public override async Task OrderBy_skip_take_take(bool isAsync)
        {
            ...
            AssertSql(@"
                ...
                SELECT FIRST @__p_2 ""t"".""CustomerID"", ""t"".""Address"", ""t"".""City"", ""t"".""CompanyName"", ""t"".""ContactName"", ""t"".""ContactTitle"", ""t"".""Country"", ""t"".""Fax"", ""t"".""Phone"", ""t"".""PostalCode"", ""t"".""Region""
                FROM (
                    SELECT ""c"".""CustomerID"", ""c"".""Address"", ""c"".""City"", ""c"".""CompanyName"", ""c"".""ContactName"", ""c"".""ContactTitle"", ""c"".""Country"", ""c"".""Fax"", ""c"".""Phone"", ""c"".""PostalCode"", ""c"".""Region""
                    FROM ""Customers"" AS ""c""
                    ORDER BY ""c"".""ContactTitle"", ""c"".""ContactName""
        ...
        public override async Task OrderBy_skip_take_take_take_take(bool isAsync)
        {
            ...
            AssertSql(@"
                ...
                FROM (
                    SELECT FIRST @__p_3 ""t0"".""CustomerID"", ""t0"".""Address"", ""t0"".""City"", ""t0"".""CompanyName"", ""t0"".""ContactName"", ""t0"".""ContactTitle"", ""t0"".""Country"", ""t0"".""Fax"", ""t0"".""Phone"", ""t0"".""PostalCode"", ""t0"".""Region""
                    FROM (
                        SELECT FIRST @__p_2 ""t"".""CustomerID"", ""t"".""Address"", ""t"".""City"", ""t"".""CompanyName"", ""t"".""ContactName"", ""t"".""ContactTitle"", ""t"".""Country"", ""t"".""Fax"", ""t"".""Phone"", ""t"".""PostalCode"", ""t"".""Region""
                        FROM (
                            SELECT ""c"".""CustomerID"", ""c"".""Address"", ""c"".""City"", ""c"".""CompanyName"", ""c"".""ContactName"", ""c"".""ContactTitle"", ""c"".""Country"", ""c"".""Fax"", ""c"".""Phone"", ""c"".""PostalCode"", ""c"".""Region""
        ...
        public override Task Projection_when_arithmetic_expressions(bool isAsync)
        {
            return base.Projection_when_arithmetic_expressions(isAsync);
        }

        [ActianTodo]
        public override Task Projection_when_arithmetic_mixed(bool isAsync)
        {
            return base.Projection_when_arithmetic_mixed(isAsync);
        }
        ...
        public override Task Queryable_reprojection(bool isAsync)
        {
            return base.Queryable_reprojection(isAsync);
        }
        ...
        public override Task SelectMany_after_client_method(bool isAsync)
        {
            return base.SelectMany_after_client_method(isAsync);
        }
        ...
        [ActianTodo]
        public override Task SelectMany_customer_orders(bool isAsync)
        {
            return base.SelectMany_customer_orders(isAsync);
        }
        ...
        public override Task SelectMany_mixed(bool isAsync)
        {
            return base.SelectMany_mixed(isAsync);
        }
        ...
        public override void Select_bitwise_and()
        {
            ...
            {
                AssertSql(@"
                    SELECT ""c"".""CustomerID"", BOOLEAN(INT1(CASE
                        WHEN ""c"".""CustomerID"" = N'ALFKI' THEN TRUE
                        ELSE FALSE
                    END) & INT1(CASE
                        WHEN ""c"".""CustomerID"" = N'ANATR' THEN TRUE
                        ELSE FALSE
                    END)) AS ""Value""
                    FROM ""Customers"" AS ""c""
                    ORDER BY ""c"".""CustomerID""
        ...
        public override void Select_bitwise_and_or()
        {
            ...
            AssertSql(@"
                SELECT ""c"".""CustomerID"", BOOLEAN(INT1(BOOLEAN(INT1(CASE
                    WHEN ""c"".""CustomerID"" = N'ALFKI' THEN TRUE
                    ELSE FALSE
                END) & INT1(CASE
                    WHEN ""c"".""CustomerID"" = N'ANATR' THEN TRUE
                    ELSE FALSE
                END))) | INT1(CASE
                    WHEN ""c"".""CustomerID"" = N'ANTON' THEN TRUE
                    ELSE FALSE
                END)) AS ""Value""
                FROM ""Customers"" AS ""c""
                ORDER BY ""c"".""CustomerID""
        ...
        public override void Select_bitwise_and_with_logical_and()
        {
            ...
            AssertSql(@"
                SELECT ""c"".""CustomerID"", CASE
                    WHEN ((BOOLEAN(INT1(CASE
                        WHEN ""c"".""CustomerID"" = N'ALFKI' THEN TRUE
                        ELSE FALSE
                    END) & INT1(CASE
                        WHEN ""c"".""CustomerID"" = N'ANATR' THEN TRUE
                        ELSE FALSE
                    END))) = TRUE) AND (""c"".""CustomerID"" = N'ANTON') THEN TRUE
                    ELSE FALSE
                END AS ""Value""
                FROM ""Customers"" AS ""c""
                ORDER BY ""c"".""CustomerID""
            ...
            AssertSql(@"
                SELECT ""c"".""CustomerID"", CASE
                    ...
                    END) | INT1(CASE
                        WHEN ""c"".""CustomerID"" = N'ANATR' THEN TRUE
                        ELSE FALSE
                    END))) = TRUE) OR (""c"".""CustomerID"" = N'ANTON') THEN TRUE
                    ELSE FALSE
                END AS ""Value""
                FROM ""Customers"" AS ""c""
                ORDER BY ""c"".""CustomerID""
        ...
        public override async Task Select_correlated_subquery_projection(bool isAsync)
        {
            ...
            AssertSql(
                @"
                    ...
                    SELECT FIRST @__p_0 ""cc"".""CustomerID""
        ...
        public override Task Select_expression_datetime_add_ticks(bool isAsync)
        {
            return base.Select_expression_datetime_add_ticks(isAsync);
        }
        ...
        [ActianTodo]
        public override Task Select_nested_collection_in_anonymous_type(bool isAsync)
        {
            return base.Select_nested_collection_in_anonymous_type(isAsync);
        }
        ...
        public override Task Select_Property_when_non_shadow(bool isAsync)
        {
            return base.Select_Property_when_non_shadow(isAsync);
        }

        public override Task Select_Property_when_shadow(bool isAsync)
        {
            return base.Select_Property_when_shadow(isAsync);
        }
        ...
        [ActianTodo]
        public override Task Select_subquery_recursive_trivial(bool isAsync)
        {
            return base.Select_subquery_recursive_trivial(isAsync);
        }
        ...
        public override async Task Select_take_skip_null_coalesce_operator(bool isAsync)
        {
            ...
            AssertSql(@"
                ...
                FROM (
                    SELECT FIRST @__p_0 ""c"".""CustomerID"", ""c"".""CompanyName"", COALESCE(""c"".""Region"", N'ZZ') AS ""c""
                    FROM ""Customers"" AS ""c""
                    ORDER BY COALESCE(""c"".""Region"", N'ZZ')
                ) AS ""t""
                ORDER BY ""t"".""c""
        ...
        public override async Task Select_take_skip_null_coalesce_operator2(bool isAsync)
        {
            ...
            AssertSql(@"
                ...
                FROM (
                    SELECT FIRST @__p_0 ""c"".""CustomerID"", ""c"".""CompanyName"", ""c"".""Region"", COALESCE(""c"".""Region"", N'ZZ') AS ""c""
                    FROM ""Customers"" AS ""c""
                    ORDER BY COALESCE(""c"".""Region"", N'ZZ')
                ) AS ""t""
                ORDER BY ""t"".""c""
        ...
        public override async Task Select_take_skip_null_coalesce_operator3(bool isAsync)
        {
            ...
            AssertSql(@"
                ...
                SELECT ""t"".""CustomerID"", ""t"".""Address"", ""t"".""City"", ""t"".""CompanyName"", ""t"".""ContactName"", ""t"".""ContactTitle"", ""t"".""Country"", ""t"".""Fax"", ""t"".""Phone"", ""t"".""PostalCode"", ""t"".""Region""
                FROM (
                    SELECT FIRST @__p_0 ""c"".""CustomerID"", ""c"".""Address"", ""c"".""City"", ""c"".""CompanyName"", ""c"".""ContactName"", ""c"".""ContactTitle"", ""c"".""Country"", ""c"".""Fax"", ""c"".""Phone"", ""c"".""PostalCode"", ""c"".""Region"", COALESCE(""c"".""Region"", N'ZZ') AS ""c""
                    FROM ""Customers"" AS ""c""
                    ORDER BY COALESCE(""c"".""Region"", N'ZZ')
                ) AS ""t""
                ORDER BY ""t"".""c""
        ...
        public override void Select_Where_Subquery_Equality()
        {
            ...
            AssertSql(@"
                ...
                WHERE (
                    SELECT COUNT(*)
                    FROM (
                        SELECT FIRST 2 ""o0"".""OrderID"", ""o0"".""ProductID"", ""o0"".""Discount"", ""o0"".""Quantity"", ""o0"".""UnitPrice""
                        FROM ""Order Details"" AS ""o0""
                        ORDER BY ""o0"".""OrderID""
                    ) AS ""t0""
                    WHERE ((
                        SELECT FIRST 1 ""c"".""Country""
                        FROM ""Customers"" AS ""c""
                        WHERE ""c"".""CustomerID"" = ""t"".""CustomerID""
                        ORDER BY ""c"".""CustomerID"") = (
                        SELECT FIRST 1 ""c0"".""Country""
                        FROM ""Orders"" AS ""o1""
            ...
            AssertSql(@"
                ...
                SELECT CASE
                    WHEN NOT EXISTS (
                        ...
                        WHERE NOT (""t"".""CustomerID"" LIKE N'B%')) THEN TRUE
                    ELSE FALSE
                END
            ");
        }
            ...
            AssertSql(@"
                ...
                SELECT CASE
                    WHEN EXISTS (
                        ...
                        FROM ""Customers"" AS ""c""
                        ORDER BY ""c"".""ContactName""
                        OFFSET @__p_0 ROWS FETCH NEXT @__p_1 ROWS ONLY) THEN TRUE
                    ELSE FALSE
                END
            ");
        }
            ...
            AssertSql(@"
                ...
                SELECT CASE
                    WHEN EXISTS (
                        ...
                        WHERE ""t"".""CustomerID"" LIKE N'C%') THEN TRUE
                    ELSE FALSE
                END
            ");
        }
            ...
            AssertSql(@"
                ...
                SELECT CASE
                    WHEN NOT EXISTS (
                        ...
                        WHERE NOT (""t"".""CustomerID"" LIKE N'A%')) THEN TRUE
                    ELSE FALSE
                END
            ");
        }
            ...
            AssertSql(@"
                ...
                SELECT CASE
                    WHEN EXISTS (
                        ...
                        WHERE ""t"".""CustomerID"" LIKE N'B%') THEN TRUE
                    ELSE FALSE
                END
            ");
        }
        ...
        [ActianTodo]
        public override Task Take_Distinct(bool isAsync)
        {
            return base.Take_Distinct(isAsync);
        }
        ...
        public override async Task Take_with_single(bool isAsync)
        {
            ...
            AssertSql(@"
                ...
                SELECT FIRST 2 ""t"".""CustomerID"", ""t"".""Address"", ""t"".""City"", ""t"".""CompanyName"", ""t"".""ContactName"", ""t"".""ContactTitle"", ""t"".""Country"", ""t"".""Fax"", ""t"".""Phone"", ""t"".""PostalCode"", ""t"".""Region""
                FROM (
                    SELECT FIRST @__p_0 ""c"".""CustomerID"", ""c"".""Address"", ""c"".""City"", ""c"".""CompanyName"", ""c"".""ContactName"", ""c"".""ContactTitle"", ""c"".""Country"", ""c"".""Fax"", ""c"".""Phone"", ""c"".""PostalCode"", ""c"".""Region""
                    FROM ""Customers"" AS ""c""
                    ORDER BY ""c"".""CustomerID""
        ...
        public override async Task Take_with_single_select_many(bool isAsync)
        {
            ...
            AssertSql(@"
                ...
                SELECT FIRST 2 ""t"".""CustomerID"", ""t"".""Address"", ""t"".""City"", ""t"".""CompanyName"", ""t"".""ContactName"", ""t"".""ContactTitle"", ""t"".""Country"", ""t"".""Fax"", ""t"".""Phone"", ""t"".""PostalCode"", ""t"".""Region"", ""t"".""OrderID"", ""t"".""CustomerID0"", ""t"".""EmployeeID"", ""t"".""OrderDate""
                FROM (
                    SELECT FIRST @__p_0 ""c"".""CustomerID"", ""c"".""Address"", ""c"".""City"", ""c"".""CompanyName"", ""c"".""ContactName"", ""c"".""ContactTitle"", ""c"".""Country"", ""c"".""Fax"", ""c"".""Phone"", ""c"".""PostalCode"", ""c"".""Region"", ""o"".""OrderID"", ""o"".""CustomerID"" AS ""CustomerID0"", ""o"".""EmployeeID"", ""o"".""OrderDate""
                    FROM ""Customers"" AS ""c""
                    CROSS JOIN ""Orders"" AS ""o""
        ...
        public override Task Ternary_should_not_evaluate_both_sides(bool isAsync)
        {
            return base.Ternary_should_not_evaluate_both_sides(isAsync);
        }

        public override Task Ternary_should_not_evaluate_both_sides_with_parameter(bool isAsync)
        {
            return base.Ternary_should_not_evaluate_both_sides_with_parameter(isAsync);
        }
        ...
        public override async Task Where_bitwise_and_with_logical_and(bool isAsync)
        {
            ...
            AssertSql(@"
                SELECT ""c"".""CustomerID"", ""c"".""Address"", ""c"".""City"", ""c"".""CompanyName"", ""c"".""ContactName"", ""c"".""ContactTitle"", ""c"".""Country"", ""c"".""Fax"", ""c"".""Phone"", ""c"".""PostalCode"", ""c"".""Region""
                FROM ""Customers"" AS ""c""
                WHERE ((BOOLEAN(INT1(CASE
                    WHEN ""c"".""CustomerID"" = N'ALFKI' THEN TRUE
                    ELSE FALSE
                END) & INT1(CASE
                    WHEN ""c"".""CustomerID"" = N'ANATR' THEN TRUE
                    ELSE FALSE
                END))) = TRUE) AND (""c"".""CustomerID"" = N'ANTON')
            ");
        }
        ...
        public override async Task Where_bitwise_and_with_logical_or(bool isAsync)
        {
            ...
            AssertSql(@"
                ...
                END) & INT1(CASE
                    WHEN ""c"".""CustomerID"" = N'ANATR' THEN TRUE
                    ELSE FALSE
                END))) = TRUE) OR (""c"".""CustomerID"" = N'ANTON')
            ");
        }
        ...
        public override async Task Where_bitwise_or_with_logical_and(bool isAsync)
        {
            ...
            AssertSql(@"
                ...
                END) | INT1(CASE
                    WHEN ""c"".""CustomerID"" = N'ANATR' THEN TRUE
                    ELSE FALSE
                END))) = TRUE) AND (""c"".""Country"" = N'Germany')
            ");
        }
        ...
        public override Task Where_Property_shadow_closure(bool isAsync)
        {
            return base.Where_Property_shadow_closure(isAsync);
        }

        public override Task Where_Property_when_non_shadow(bool isAsync)
        {
            return base.Where_Property_when_non_shadow(isAsync);
        }

        public override Task Where_Property_when_shadow(bool isAsync)
        {
            return base.Where_Property_when_shadow(isAsync);
        }
        ...
        public override Task Where_query_composition3(bool isAsync)
        {
            return base.Where_query_composition3(isAsync);
        }

        public override Task Where_query_composition4(bool isAsync)
        {
            return base.Where_query_composition4(isAsync);
        }

        public override Task Where_query_composition5(bool isAsync)
        {
            return base.Where_query_composition5(isAsync);
        }

        public override Task Where_query_composition6(bool isAsync)
        {
            return base.Where_query_composition6(isAsync);
        }
        ...
        public override async Task Where_subquery_anon_nested(bool isAsync)
        {
            ...
            AssertSql(@"
                ...
                CROSS JOIN (
                    SELECT FIRST @__p_1 ""c"".""CustomerID"", ""c"".""Address"", ""c"".""City"", ""c"".""CompanyName"", ""c"".""ContactName"", ""c"".""ContactTitle"", ""c"".""Country"", ""c"".""Fax"", ""c"".""Phone"", ""c"".""PostalCode"", ""c"".""Region""
                    FROM ""Customers"" AS ""c""
                ) AS ""t1""
        ...
        public override Task Where_subquery_expression(bool isAsync)
        {
            return base.Where_subquery_expression(isAsync);
        }

        public override Task Where_subquery_expression_same_parametername(bool isAsync)
        {
            return base.Where_subquery_expression_same_parametername(isAsync);
        }
