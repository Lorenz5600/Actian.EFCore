...
{
    public class ComplexNavigationsQueryActianTest : ComplexNavigationsQueryRelationalTestBase<ComplexNavigationsQueryActianFixture>
    {
...
SELECT "l1"."Name"
FROM (
    SELECT FIRST @__p_0 "l"."Id", "l0"."Level1_Optional_Id"
    FROM "LevelOne" AS "l"
    LEFT JOIN "LevelTwo" AS "l0" ON "l"."Id" = "l0"."Level1_Optional_Id"
    ORDER BY "l"."Id"
) AS "t"
...
WHERE (
    SELECT COUNT(*)
    FROM (
        SELECT FIRST 10 "l0"."Id", "l1"."Id" AS "Id0"
        FROM "LevelOne" AS "l0"
        LEFT JOIN "LevelTwo" AS "l1" ON "l0"."Id" = "l1"."Level1_Optional_Id"
        WHERE (
            SELECT COUNT(*)
        ...
        public override async Task GroupJoin_client_method_in_OrderBy(bool async)
        {
            await AssertTranslationFailedWithDetails(
                ...
                CoreStrings.QueryUnableToTranslateMethod(
                    "Microsoft.EntityFrameworkCore.Query.ComplexNavigationsQueryTestBase<Microsoft.EntityFrameworkCore.Query.ComplexNavigationsQueryActianFixture>",
...
SELECT (
    ...
    FROM (
        SELECT DISTINCT FIRST 1 "l0"."Id", "l0"."Level2_Optional_Id", "l0"."Level2_Required_Id", "l0"."Name", "l0"."OneToMany_Optional_Inverse3Id", "l0"."OneToMany_Optional_Self_Inverse3Id", "l0"."OneToMany_Required_Inverse3Id", "l0"."OneToMany_Required_Self_Inverse3Id", "l0"."OneToOne_Optional_PK_Inverse3Id", "l0"."OneToOne_Optional_Self3Id"
        FROM "LevelThree" AS "l0"
    ) AS "t"
    ORDER BY "t"."Id")
FROM "LevelOne" AS "l"
...
""");
        ...
        public override async Task Entries_for_detached_entities_are_removed(bool async)
        {
            ...
            AssertSql(
                """
SELECT FIRST 1 "l"."Id", "l"."Date", "l"."Level1_Optional_Id", "l"."Level1_Required_Id", "l"."Name", "l"."OneToMany_Optional_Inverse2Id", "l"."OneToMany_Optional_Self_Inverse2Id", "l"."OneToMany_Required_Inverse2Id", "l"."OneToMany_Required_Self_Inverse2Id", "l"."OneToOne_Optional_PK_Inverse2Id", "l"."OneToOne_Optional_Self2Id"
FROM "LevelTwo" AS "l"
ORDER BY "l"."Id"
""");
        }
