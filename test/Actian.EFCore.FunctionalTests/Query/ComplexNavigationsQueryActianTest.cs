...
namespace Actian.EFCore.Query
{
    public class ComplexNavigationsQueryActianTest : ComplexNavigationsQueryTestBase<ComplexNavigationsQueryActianFixture>
    {
        ...
        public override Task Simple_level1_include(bool isAsync)
        {
            return base.Simple_level1_include(isAsync);
        }

        public override Task Simple_level1(bool isAsync)
        {
            return base.Simple_level1(isAsync);
        }
        ...
        public override async Task Method_call_on_optional_navigation_translates_to_null_conditional_properly_for_arguments(bool isAsync)
        {
            ...
            AssertSql(@"
                ...
                FROM ""LevelOne"" AS ""l""
                LEFT JOIN ""LevelTwo"" AS ""l0"" ON ""l"".""Id"" = ""l0"".""Level1_Optional_Id""
                WHERE (""l0"".""Name"" = N'') OR (""l0"".""Name"" IS NOT NULL AND (""l0"".""Name"" IS NOT NULL AND (LEFT(""l0"".""Name"", LEN(""l0"".""Name"")) = ""l0"".""Name"")))
            ");
        }
        ...
        public override async Task Optional_navigation_projected_into_DTO(bool isAsync)
        {
            ...
            AssertSql(@"
                SELECT ""l"".""Id"", ""l"".""Name"", CASE
                    WHEN ""l0"".""Id"" IS NOT NULL THEN TRUE
                    ELSE FALSE
                END, ""l0"".""Id"", ""l0"".""Name""
                FROM ""LevelOne"" AS ""l""
                LEFT JOIN ""LevelTwo"" AS ""l0"" ON ""l"".""Id"" = ""l0"".""Level1_Optional_Id""
        ...
        public override async Task Order_by_key_of_projected_navigation_doesnt_get_optimized_into_FK_access_subquery(bool isAsync)
        {
            ...
            AssertSql(@"
                ...
                SELECT ""l1"".""Name""
                FROM (
                    SELECT FIRST @__p_0 ""l0"".""Id"", ""l0"".""Date"", ""l0"".""Level1_Optional_Id"", ""l0"".""Level1_Required_Id"", ""l0"".""Name"", ""l0"".""OneToMany_Optional_Inverse2Id"", ""l0"".""OneToMany_Optional_Self_Inverse2Id"", ""l0"".""OneToMany_Required_Inverse2Id"", ""l0"".""OneToMany_Required_Self_Inverse2Id"", ""l0"".""OneToOne_Optional_PK_Inverse2Id"", ""l0"".""OneToOne_Optional_Self2Id"", ""l"".""Id"" AS ""Id0""
                    FROM ""LevelThree"" AS ""l""
                    INNER JOIN ""LevelTwo"" AS ""l0"" ON ""l"".""Level2_Required_Id"" = ""l0"".""Id""
                    ORDER BY ""l0"".""Id""
                ) AS ""t""
        ...
        public override async Task GroupJoin_on_a_subquery_containing_another_GroupJoin_projecting_outer(bool isAsync)
        {
            ...
            AssertSql(@"
                ...
                SELECT ""l1"".""Name""
                FROM (
                    SELECT FIRST @__p_0 ""l"".""Id"", ""l"".""Date"", ""l"".""Name"", ""l"".""OneToMany_Optional_Self_Inverse1Id"", ""l"".""OneToMany_Required_Self_Inverse1Id"", ""l"".""OneToOne_Optional_Self1Id""
                    FROM ""LevelOne"" AS ""l""
                    LEFT JOIN ""LevelTwo"" AS ""l0"" ON ""l"".""Id"" = ""l0"".""Level1_Optional_Id""
                    ORDER BY ""l"".""Id""
                ) AS ""t""
        ...
        public override async Task GroupJoin_on_a_subquery_containing_another_GroupJoin_projecting_outer_with_client_method(bool isAsync)
        {
            ...
            AssertSql(
                ...
                @"
                    ...
                    SELECT FIRST @__p_0 ""l10"".""Id"", ""l10"".""Date"", ""l10"".""Name"", ""l10"".""OneToMany_Optional_Self_Inverse1Id"", ""l10"".""OneToMany_Required_Self_Inverse1Id"", ""l10"".""OneToOne_Optional_Self1Id""
                    FROM ""LevelOne"" AS ""l10""
            ...
            bool isAsync)
        {
            ...
            AssertSql(@"
                ...
                SELECT ""l1"".""Name""
                FROM (
                    SELECT FIRST @__p_0 ""t"".""Id"", ""t"".""Date"", ""t"".""Level1_Optional_Id"", ""t"".""Level1_Required_Id"", ""t"".""Name"", ""t"".""OneToMany_Optional_Inverse2Id"", ""t"".""OneToMany_Optional_Self_Inverse2Id"", ""t"".""OneToMany_Required_Inverse2Id"", ""t"".""OneToMany_Required_Self_Inverse2Id"", ""t"".""OneToOne_Optional_PK_Inverse2Id"", ""t"".""OneToOne_Optional_Self2Id"", ""l"".""Id"" AS ""Id0""
                    FROM ""LevelOne"" AS ""l""
                    LEFT JOIN (
                        SELECT ""l0"".""Id"", ""l0"".""Date"", ""l0"".""Level1_Optional_Id"", ""l0"".""Level1_Required_Id"", ""l0"".""Name"", ""l0"".""OneToMany_Optional_Inverse2Id"", ""l0"".""OneToMany_Optional_Self_Inverse2Id"", ""l0"".""OneToMany_Required_Inverse2Id"", ""l0"".""OneToMany_Required_Self_Inverse2Id"", ""l0"".""OneToOne_Optional_PK_Inverse2Id"", ""l0"".""OneToOne_Optional_Self2Id""
                        FROM ""LevelTwo"" AS ""l0""
        ...
        public override async Task GroupJoin_on_left_side_being_a_subquery(bool isAsync)
        {
            ...
            AssertSql(@"
                ...
                FROM (
                    SELECT FIRST @__p_0 ""l"".""Id"", ""l"".""Date"", ""l"".""Name"", ""l"".""OneToMany_Optional_Self_Inverse1Id"", ""l"".""OneToMany_Required_Self_Inverse1Id"", ""l"".""OneToOne_Optional_Self1Id"", ""l0"".""Name"" AS ""Name0""
                    FROM ""LevelOne"" AS ""l""
                    LEFT JOIN ""LevelTwo"" AS ""l0"" ON ""l"".""Id"" = ""l0"".""Level1_Optional_Id""
                    ORDER BY ""l0"".""Name"", ""l"".""Id""
                ) AS ""t""
        ...
        public override async Task GroupJoin_on_right_side_being_a_subquery(bool isAsync)
        {
            ...
            AssertSql(@"
                ...
                FROM ""LevelTwo"" AS ""l""
                LEFT JOIN (
                    SELECT FIRST @__p_0 ""l0"".""Id"", ""l0"".""Date"", ""l0"".""Name"", ""l0"".""OneToMany_Optional_Self_Inverse1Id"", ""l0"".""OneToMany_Required_Self_Inverse1Id"", ""l0"".""OneToOne_Optional_Self1Id"", ""l1"".""Name"" AS ""Name0""
                    FROM ""LevelOne"" AS ""l0""
                    LEFT JOIN ""LevelTwo"" AS ""l1"" ON ""l0"".""Id"" = ""l1"".""Level1_Optional_Id""
                    ORDER BY ""l1"".""Name""
            ...
            AssertSql(@"
                SELECT CASE
                    WHEN NOT EXISTS (
                        SELECT 1
                        FROM ""LevelOne"" AS ""l""
                        WHERE (""l"".""Name"" = N'Foo') AND ""l"".""Name"" IS NOT NULL) THEN TRUE
                    ELSE FALSE
                END
            ");
        }
