...
public class NorthwindMiscellaneousQueryActianTest : NorthwindMiscellaneousQueryRelationalTestBase<
    NorthwindQueryActianFixture<NoopModelCustomizer>>
{
    public NorthwindMiscellaneousQueryActianTest(
...
SELECT "o"."OrderID", "o"."CustomerID", "o"."EmployeeID", "o"."OrderDate"
FROM "Orders" AS "o"
WHERE (INT4("o"."OrderID") & INT4(10248)) = 10248
""");
    }
...
""");
    ...
    public override async Task Add_minutes_on_constant_value(bool async)
    {
        ...
        AssertSql(
            """
SELECT CAST(mod("o"."OrderID", 25) AS float)
FROM "Orders" AS "o"
    ...
    public override async Task Client_code_using_instance_method_throws(bool async)
    {
        Assert.Equal(
            CoreStrings.ClientProjectionCapturingConstantInMethodInstance(
                "Microsoft.EntityFrameworkCore.Query.NorthwindMiscellaneousQueryActianTest",
                "InstanceMethod"),
