...
{
    public class QueryNavigationsActianTest : QueryNavigationsTestBase<NorthwindQueryActianFixture<NoopModelCustomizer>>
    {
        public QueryNavigationsActianTest(NorthwindQueryActianFixture<NoopModelCustomizer> fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
        ...
        public override Task Join_with_nav_projected_in_subquery_when_client_eval(bool isAsync)
        {
            return base.Join_with_nav_projected_in_subquery_when_client_eval(isAsync);
        }
        ...
        public override Task Join_with_nav_in_predicate_in_subquery_when_client_eval(bool isAsync)
        {
            return base.Join_with_nav_in_predicate_in_subquery_when_client_eval(isAsync);
        }
        ...
        public override Task Join_with_nav_in_orderby_in_subquery_when_client_eval(bool isAsync)
        {
            return base.Join_with_nav_in_orderby_in_subquery_when_client_eval(isAsync);
        }
        ...
        public override Task Select_Where_Navigation_Async()
        {
            return base.Select_Where_Navigation_Async();
        }

        public override Task Select_Where_Navigation_Scalar_Equals_Navigation_Scalar(bool isAsync)
        {
            return base.Select_Where_Navigation_Scalar_Equals_Navigation_Scalar(isAsync);
        }
        ...
        public override Task Select_Singleton_Navigation_With_Member_Access_Async()
        {
            return base.Select_Singleton_Navigation_With_Member_Access_Async();
        }
            ...
            AssertSql(@"
                SELECT CASE
                    WHEN NOT EXISTS (
                        SELECT 1
                        FROM ""Orders"" AS ""o""
                        WHERE (""c"".""CustomerID"" = ""o"".""CustomerID"") AND ((""o"".""CustomerID"" <> N'ALFKI') OR ""o"".""CustomerID"" IS NULL)) THEN TRUE
                    ELSE FALSE
                END AS ""All""
                FROM ""Customers"" AS ""c""
            ");
        ...
        public override Task Collection_select_nav_prop_all_client(bool isAsync)
        {
            return base.Collection_select_nav_prop_all_client(isAsync);
        }
        ...
        public override Task Collection_where_nav_prop_all_client(bool isAsync)
        {
            return base.Collection_where_nav_prop_all_client(isAsync);
        }
        ...
        public override async Task Where_subquery_on_navigation(bool isAsync)
        {
            ...
            AssertSql(@"
                ...
                WHERE EXISTS (
                    ...
                    INNER JOIN (
                        SELECT FIRST 1 ""o0"".""OrderID"", ""o0"".""ProductID""
                        FROM ""Order Details"" AS ""o0""
