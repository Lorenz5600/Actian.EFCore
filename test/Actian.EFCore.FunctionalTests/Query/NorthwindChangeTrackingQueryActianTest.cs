...
public class NorthwindChangeTrackingQueryActianTest : NorthwindChangeTrackingQueryTestBase<
    NorthwindQueryActianFixture<NoopModelCustomizer>>
{
    public NorthwindChangeTrackingQueryActianTest(NorthwindQueryActianFixture<NoopModelCustomizer> fixture)
        : base(fixture)
    {
