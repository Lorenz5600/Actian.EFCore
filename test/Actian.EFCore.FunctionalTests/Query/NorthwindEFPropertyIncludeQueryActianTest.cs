...
public class NorthwindEFPropertyIncludeQueryActianTest : NorthwindEFPropertyIncludeQueryTestBase<
    NorthwindQueryActianFixture<NoopModelCustomizer>>
{
    public NorthwindEFPropertyIncludeQueryActianTest(NorthwindQueryActianFixture<NoopModelCustomizer> fixture)
        : base(fixture)
    {
