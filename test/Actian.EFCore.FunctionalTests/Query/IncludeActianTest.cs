...
{
    public class IncludeActianTest : IncludeTestBase<NorthwindQueryActianFixture<NoopModelCustomizer>>
    {
        public IncludeActianTest(NorthwindQueryActianFixture<NoopModelCustomizer> fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
        ...
        [ActianTodo]
        public override void Include_bad_navigation_property_simple()
        {
            base.Include_bad_navigation_property_simple();
        }
        ...
        public override void Include_multi_level_reference_and_collection_predicate(bool useString)
        {
            ...
            AssertSql(@"
                ...
                FROM (
                    SELECT FIRST 2 ""o"".""OrderID"", ""o"".""CustomerID"", ""o"".""EmployeeID"", ""o"".""OrderDate"", ""c"".""CustomerID"" AS ""CustomerID0"", ""c"".""Address"", ""c"".""City"", ""c"".""CompanyName"", ""c"".""ContactName"", ""c"".""ContactTitle"", ""c"".""Country"", ""c"".""Fax"", ""c"".""Phone"", ""c"".""PostalCode"", ""c"".""Region""
                    FROM ""Orders"" AS ""o""
        ...
        public override void Include_collection_with_multiple_conditional_order_by(bool useString)
        {
            ...
            AssertSql(@"
                ...
                FROM (
                    SELECT FIRST @__p_0 ""o"".""OrderID"", ""o"".""CustomerID"", ""o"".""EmployeeID"", ""o"".""OrderDate"", CASE
                        WHEN ""o"".""OrderID"" > 0 THEN TRUE
                        ELSE FALSE
                    END AS ""c"", CASE
            ...
            AssertSql(@"
                ...
                FROM (
                    SELECT ""c"".""CustomerID"", ""c"".""Address"", ""c"".""City"", ""c"".""CompanyName"", ""c"".""ContactName"", ""c"".""ContactTitle"", ""c"".""Country"", ""c"".""Fax"", ""c"".""Phone"", ""c"".""PostalCode"", ""c"".""Region"", CASE
                        WHEN ""c"".""CustomerID"" IN (N'ALFKI') THEN TRUE
                        ELSE FALSE
                    END AS ""c""
                    FROM ""Customers"" AS ""c""
                    WHERE ""c"".""CustomerID"" LIKE N'A%'
        ...
        public override void Include_collection_OrderBy_list_does_not_contains(bool useString)
        {
            ...
            AssertSql(@"
                ...
                FROM (
                    SELECT ""c"".""CustomerID"", ""c"".""Address"", ""c"".""City"", ""c"".""CompanyName"", ""c"".""ContactName"", ""c"".""ContactTitle"", ""c"".""Country"", ""c"".""Fax"", ""c"".""Phone"", ""c"".""PostalCode"", ""c"".""Region"", CASE
                        WHEN ""c"".""CustomerID"" NOT IN (N'ALFKI') THEN TRUE
                        ELSE FALSE
                    END AS ""c""
                    FROM ""Customers"" AS ""c""
                    WHERE ""c"".""CustomerID"" LIKE N'A%'
        ...
        public override Task Include_empty_reference_sets_IsLoaded(bool useString, bool async)
        {
            return base.Include_empty_reference_sets_IsLoaded(useString, async);
        }
            ...
            bool useString, bool async)
        {
            ...
            AssertSql(@"
                SELECT CASE
                    WHEN ""e0"".""EmployeeID"" IS NOT NULL THEN TRUE
                    ELSE FALSE
        ...
        [ActianTodo]
        public override Task Include_with_double_group_by(bool useString, bool async)
        {
            return base.Include_with_double_group_by(useString, async);
        }

        [ActianTodo]
        public override Task Include_with_double_group_by_no_tracking(bool useString, bool async)
        {
            return base.Include_with_double_group_by_no_tracking(useString, async);
        }

        [ActianTodo]
        public override Task Include_with_double_group_by_and_aggregate(bool useString, bool async)
        {
            return base.Include_with_double_group_by_and_aggregate(useString, async);
        }
    }
}
