...
{
    public class FromSqlQueryActianTest : FromSqlQueryTestBase<NorthwindQueryActianFixture<NoopModelCustomizer>>
    {
        public FromSqlQueryActianTest(NorthwindQueryActianFixture<NoopModelCustomizer> fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
        ...
        public override void FromSqlRaw_queryable_simple()
        {
            ...
            AssertSql(@"SELECT * FROM ""Customers"" WHERE ""ContactName"" LIKE '%z%'");
        }
        ...
        public override void FromSqlRaw_queryable_simple_columns_out_of_order()
        {
            ...
            AssertSql(@"SELECT ""Region"", ""PostalCode"", ""Phone"", ""Fax"", ""CustomerID"", ""Country"", ""ContactTitle"", ""ContactName"", ""CompanyName"", ""City"", ""Address"" FROM ""Customers""");
        }
        ...
        public override void FromSqlRaw_queryable_simple_columns_out_of_order_and_extra_columns()
        {
            ...
            AssertSql(@"SELECT ""Region"", ""PostalCode"", ""PostalCode"" AS ""Foo"", ""Phone"", ""Fax"", ""CustomerID"", ""Country"", ""ContactTitle"", ""ContactName"", ""CompanyName"", ""City"", ""Address"" FROM ""Customers""");
        }
        ...
        {
            base.Include_does_not_close_user_opened_connection_for_empty_result();
        }
        ...
        {
            base.Include_closed_connection_opened_by_it_when_buffering();
        }
