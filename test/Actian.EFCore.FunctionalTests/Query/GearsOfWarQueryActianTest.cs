...
namespace Actian.EFCore.Query
{
    public class GearsOfWarQueryActianTest : GearsOfWarQueryTestBase<GearsOfWarQueryActianFixture>
    {
        ...
        public override Task ToString_guid_property_projection(bool isAsync)
        {
            return base.ToString_guid_property_projection(isAsync);
        }

        public override Task Include_multiple_one_to_one_and_one_to_many_self_reference(bool isAsync)
        {
            return base.Include_multiple_one_to_one_and_one_to_many_self_reference(isAsync);
        }
        ...
        public override Task Include_multiple_one_to_one_and_one_to_one_and_one_to_many(bool isAsync)
        {
            return base.Include_multiple_one_to_one_and_one_to_one_and_one_to_many(isAsync);
        }
        ...
        public override Task Include_multiple_include_then_include(bool isAsync)
        {
            return base.Include_multiple_include_then_include(isAsync);
        }
        ...
        public override async Task Where_bitwise_and_enum(bool isAsync)
        {
            ...
            AssertSql(
                @"
                    SELECT ""g"".""Nickname"", ""g"".""SquadId"", ""g"".""AssignedCityName"", ""g"".""CityOfBirthName"", ""g"".""Discriminator"", ""g"".""FullName"", ""g"".""HasSoulPatch"", ""g"".""LeaderNickname"", ""g"".""LeaderSquadId"", ""g"".""Rank""
                    FROM ""Gears"" AS ""g""
                    WHERE ""g"".""Discriminator"" IN (N'Gear', N'Officer') AND ((INT4(""g"".""Rank"") & INT4(1)) > 0)
                ",
                @"
                    SELECT ""g"".""Nickname"", ""g"".""SquadId"", ""g"".""AssignedCityName"", ""g"".""CityOfBirthName"", ""g"".""Discriminator"", ""g"".""FullName"", ""g"".""HasSoulPatch"", ""g"".""LeaderNickname"", ""g"".""LeaderSquadId"", ""g"".""Rank""
                    FROM ""Gears"" AS ""g""
                    WHERE ""g"".""Discriminator"" IN (N'Gear', N'Officer') AND ((INT4(""g"".""Rank"") & INT4(1)) = 1)
                "
            );
        }
        ...
        public override async Task Where_bitwise_and_integral(bool isAsync)
        {
            ...
            AssertSql(
                ...
                @"
                    SELECT ""g"".""Nickname"", ""g"".""SquadId"", ""g"".""AssignedCityName"", ""g"".""CityOfBirthName"", ""g"".""Discriminator"", ""g"".""FullName"", ""g"".""HasSoulPatch"", ""g"".""LeaderNickname"", ""g"".""LeaderSquadId"", ""g"".""Rank""
                    FROM ""Gears"" AS ""g""
                    WHERE ""g"".""Discriminator"" IN (N'Gear', N'Officer') AND ((INT8(CAST(""g"".""Rank"" AS bigint)) & INT8(1)) = 1)
                ",
                @"
                    SELECT ""g"".""Nickname"", ""g"".""SquadId"", ""g"".""AssignedCityName"", ""g"".""CityOfBirthName"", ""g"".""Discriminator"", ""g"".""FullName"", ""g"".""HasSoulPatch"", ""g"".""LeaderNickname"", ""g"".""LeaderSquadId"", ""g"".""Rank""
                    FROM ""Gears"" AS ""g""
                    WHERE ""g"".""Discriminator"" IN (N'Gear', N'Officer') AND ((INT2(CAST(""g"".""Rank"" AS smallint)) & INT2(1)) = 1)
                "
            );
        }
        ...
        public override async Task Where_bitwise_and_nullable_enum_with_constant(bool isAsync)
        {
            ...
            AssertSql(@"
                SELECT ""w"".""Id"", ""w"".""AmmunitionType"", ""w"".""IsAutomatic"", ""w"".""Name"", ""w"".""OwnerFullName"", ""w"".""SynergyWithId""
                FROM ""Weapons"" AS ""w""
                WHERE (INT4(""w"".""AmmunitionType"") & INT4(1)) > 0
            ");
        }
        ...
        public override async Task Where_bitwise_and_nullable_enum_with_null_constant(bool isAsync)
        {
            ...
            finally
            {
                AssertSql(@"
                    SELECT ""w"".""Id"", ""w"".""AmmunitionType"", ""w"".""IsAutomatic"", ""w"".""Name"", ""w"".""OwnerFullName"", ""w"".""SynergyWithId""
                    FROM ""Weapons"" AS ""w""
                    WHERE (INT4(""w"".""AmmunitionType"") & INT4(NULL)) > 0
                ");
            }
        }
        ...
        public override async Task Where_bitwise_and_nullable_enum_with_non_nullable_parameter(bool isAsync)
        {
            ...
            AssertSql(@"
                ...
                SELECT ""w"".""Id"", ""w"".""AmmunitionType"", ""w"".""IsAutomatic"", ""w"".""Name"", ""w"".""OwnerFullName"", ""w"".""SynergyWithId""
                FROM ""Weapons"" AS ""w""
                WHERE (INT4(""w"".""AmmunitionType"") & INT4(@__ammunitionType_0)) > 0
            ");
        }
        ...
        public override async Task Bitwise_projects_values_in_select(bool isAsync)
        {
            ...
            AssertSql(@"
                SELECT FIRST 1 CASE
                    WHEN (INT4(""g"".""Rank"") & INT4(1)) = 1 THEN TRUE
                    ELSE FALSE
                END AS ""BitwiseTrue"", CASE
                    WHEN (INT4(""g"".""Rank"") & INT4(1)) = 2 THEN TRUE
                    ELSE FALSE
                END AS ""BitwiseFalse"", INT4(""g"".""Rank"") & INT4(1) AS ""BitwiseValue""
                FROM ""Gears"" AS ""g""
                WHERE ""g"".""Discriminator"" IN (N'Gear', N'Officer') AND ((INT4(""g"".""Rank"") & INT4(1)) = 1)
            ");
        }
            ...
            AssertSql(
                @"
                    ...
                    WHERE ""g"".""Discriminator"" IN (N'Gear', N'Officer') AND (((""g"".""Rank"" & (
                        ...
                        FROM ""Gears"" AS ""g0""
                        WHERE ""g0"".""Discriminator"" IN (N'Gear', N'Officer')
                        ORDER BY ""g0"".""Nickname"", ""g0"".""SquadId"")) OR (""g"".""Rank"" & (
                        SELECT FIRST 1 ""g0"".""Rank""
                        FROM ""Gears"" AS ""g0""
                        WHERE ""g0"".""Discriminator"" IN (N'Gear', N'Officer')
                ...
                @"
                    ...
                    WHERE ""g"".""Discriminator"" IN (N'Gear', N'Officer') AND (((1 & (
                        ...
                        FROM ""Gears"" AS ""g0""
                        WHERE ""g0"".""Discriminator"" IN (N'Gear', N'Officer')
                        ORDER BY ""g0"".""Nickname"", ""g0"".""SquadId"")) OR (1 & (
                        SELECT FIRST 1 ""g0"".""Rank""
                        FROM ""Gears"" AS ""g0""
                        WHERE ""g0"".""Discriminator"" IN (N'Gear', N'Officer')
                        ORDER BY ""g0"".""Nickname"", ""g0"".""SquadId"") IS NULL AND (
        ...
        public override async Task Select_enum_has_flag(bool isAsync)
        {
            ...
            AssertSql(@"
                SELECT FIRST 1 CASE
                    WHEN (""g"".""Rank"" & 1) = 1 THEN TRUE
                    ELSE FALSE
                END AS ""hasFlagTrue"", CASE
                    WHEN (""g"".""Rank"" & 2) = 2 THEN TRUE
                    ELSE FALSE
                END AS ""hasFlagFalse""
                FROM ""Gears"" AS ""g""
                WHERE ""g"".""Discriminator"" IN (N'Gear', N'Officer') AND ((""g"".""Rank"" & 1) = 1)
        ...
        public override async Task Select_comparison_with_null(bool isAsync)
        {
            ...
            AssertSql(
                @"
                    ...
                    SELECT ""w"".""Id"", CASE
                        WHEN (""w"".""AmmunitionType"" = @__ammunitionType_0) AND ""w"".""AmmunitionType"" IS NOT NULL THEN TRUE
                        ELSE FALSE
                    END AS ""Cartridge""
                    FROM ""Weapons"" AS ""w""
                    WHERE ""w"".""AmmunitionType"" = @__ammunitionType_0
                ...
                @"
                    SELECT ""w"".""Id"", CASE
                        WHEN ""w"".""AmmunitionType"" IS NULL THEN TRUE
                        ELSE FALSE
                    END AS ""Cartridge""
                    FROM ""Weapons"" AS ""w""
                    WHERE ""w"".""AmmunitionType"" IS NULL
        ...
        public override async Task Select_ternary_operation_multiple_conditions_2(bool isAsync)
        {
            ...
            AssertSql(@"
                SELECT ""w"".""Id"", CASE
                    WHEN (""w"".""IsAutomatic"" <> TRUE) AND (""w"".""SynergyWithId"" = 1) THEN N'Yes'
                    ELSE N'No'
                END AS ""IsCartridge""
                FROM ""Weapons"" AS ""w""
            ");
        ...
        public override async Task Select_multiple_conditions(bool isAsync)
        {
            ...
            AssertSql(@"
                SELECT ""w"".""Id"", CASE
                    WHEN (""w"".""IsAutomatic"" <> TRUE) AND ((""w"".""SynergyWithId"" = 1) AND ""w"".""SynergyWithId"" IS NOT NULL) THEN TRUE
                    ELSE FALSE
                END AS ""IsCartridge""
                FROM ""Weapons"" AS ""w""
            ");
        ...
        public override async Task Null_propagation_optimization1(bool isAsync)
        {
            ...
            AssertSql(@"
                ...
                WHERE ""g"".""Discriminator"" IN (N'Gear', N'Officer') AND (CASE
                    WHEN (""g"".""LeaderNickname"" = N'Marcus') AND ""g"".""LeaderNickname"" IS NOT NULL THEN TRUE
                    ELSE FALSE
                END = TRUE)
            ");
        }
            ...
            AssertSql(@"
                SELECT CASE
                    WHEN ""g"".""LeaderNickname"" IS NOT NULL THEN CASE
                        WHEN (CAST(LEN(""g"".""Nickname"") AS int) = 5) AND LEN(""g"".""Nickname"") IS NOT NULL THEN TRUE
                        ELSE FALSE
                    END
                    ELSE NULL
                END
        ...
        public override async Task Select_null_propagation_negative4(bool isAsync)
        {
            ...
            AssertSql(@"
                SELECT CASE
                    WHEN ""t"".""Nickname"" IS NOT NULL THEN TRUE
                    ELSE FALSE
                END, ""t"".""Nickname""
                FROM ""Gears"" AS ""g""
                LEFT JOIN (
        ...
        public override async Task Select_null_propagation_negative6(bool isAsync)
        {
            ...
            AssertSql(@"
                SELECT CASE
                    WHEN ""g"".""LeaderNickname"" IS NOT NULL THEN CASE
                        WHEN ((CAST(LEN(""g"".""LeaderNickname"") AS int) <> CAST(LEN(""g"".""LeaderNickname"") AS int)) OR LEN(""g"".""LeaderNickname"") IS NULL) AND LEN(""g"".""LeaderNickname"") IS NOT NULL THEN TRUE
                        ELSE FALSE
                    END
                    ELSE NULL
                END
        ...
        public override async Task Select_null_propagation_negative7(bool isAsync)
        {
            ...
            AssertSql(@"
                SELECT CASE
                    WHEN ""g"".""LeaderNickname"" IS NOT NULL THEN CASE
                        WHEN ((""g"".""LeaderNickname"" = ""g"".""LeaderNickname"") AND ""g"".""LeaderNickname"" IS NOT NULL) OR ""g"".""LeaderNickname"" IS NULL THEN TRUE
                        ELSE FALSE
                    END
                    ELSE NULL
                END
        ...
        public override async Task Select_conditional_with_anonymous_type_and_null_constant(bool isAsync)
        {
            ...
            AssertSql(@"
                SELECT CASE
                    WHEN ""g"".""LeaderNickname"" IS NOT NULL THEN TRUE
                    ELSE FALSE
                END, ""g"".""HasSoulPatch""
                FROM ""Gears"" AS ""g""
                WHERE ""g"".""Discriminator"" IN (N'Gear', N'Officer')
        ...
        public override async Task Optional_Navigation_Null_Coalesce_To_Clr_Type(bool isAsync)
        {
            ...
            AssertSql(@"
                SELECT FIRST 1 COALESCE(""w0"".""IsAutomatic"", FALSE) AS ""IsAutomatic""
                FROM ""Weapons"" AS ""w""
        ...
        public override async Task Where_subquery_distinct_firstordefault_boolean(bool isAsync)
        {
            ...
            AssertSql(@"
                SELECT ""g"".""Nickname"", ""g"".""SquadId"", ""g"".""AssignedCityName"", ""g"".""CityOfBirthName"", ""g"".""Discriminator"", ""g"".""FullName"", ""g"".""HasSoulPatch"", ""g"".""LeaderNickname"", ""g"".""LeaderSquadId"", ""g"".""Rank""
                FROM ""Gears"" AS ""g""
                WHERE ""g"".""Discriminator"" IN (N'Gear', N'Officer') AND ((""g"".""HasSoulPatch"" = TRUE) AND ((
                    SELECT FIRST 1 ""t"".""IsAutomatic""
                    FROM (
        ...
        public override async Task Where_subquery_distinct_singleordefault_boolean2(bool isAsync)
        {
            ...
            AssertSql(@"
                ...
                FROM ""Gears"" AS ""g""
                WHERE ""g"".""Discriminator"" IN (N'Gear', N'Officer') AND ((""g"".""HasSoulPatch"" = TRUE) AND ((
                    SELECT DISTINCT FIRST 1 ""w"".""IsAutomatic""
                    FROM ""Weapons"" AS ""w""
                    WHERE (""g"".""FullName"" = ""w"".""OwnerFullName"") AND (CHARINDEX(N'Lancer', ""w"".""Name"") > 0)) = TRUE))
                ORDER BY ""g"".""Nickname""
            ");
        }
        ...
        public override Task Where_subquery_concat_firstordefault_boolean(bool isAsync)
        {
            return base.Where_subquery_concat_firstordefault_boolean(isAsync);
        }
        ...
        {
            return base.Select_navigation_with_concat_and_count(isAsync);
        }

        public override Task Where_subquery_concat_order_by_firstordefault_boolean(bool isAsync)
        {
            return base.Where_subquery_concat_order_by_firstordefault_boolean(isAsync);
        }

        public override Task Concat_with_collection_navigations(bool isAsync)
        {
            return base.Concat_with_collection_navigations(isAsync);
        }

        public override Task Union_with_collection_navigations(bool isAsync)
        {
        ...
        public override Task Select_Where_Navigation_Client(bool isAsync)
        {
            return base.Select_Where_Navigation_Client(isAsync);
        }
        ...
        public override async Task Coalesce_operator_in_predicate(bool isAsync)
        {
            ...
            AssertSql(@"
                SELECT ""w"".""Id"", ""w"".""AmmunitionType"", ""w"".""IsAutomatic"", ""w"".""Name"", ""w"".""OwnerFullName"", ""w"".""SynergyWithId""
                FROM ""Weapons"" AS ""w""
                WHERE COALESCE(""w"".""IsAutomatic"", FALSE) = TRUE
            ");
        }
        ...
        public override async Task Coalesce_operator_in_predicate_with_other_conditions(bool isAsync)
        {
            ...
            AssertSql(@"
                SELECT ""w"".""Id"", ""w"".""AmmunitionType"", ""w"".""IsAutomatic"", ""w"".""Name"", ""w"".""OwnerFullName"", ""w"".""SynergyWithId""
                FROM ""Weapons"" AS ""w""
                WHERE (""w"".""AmmunitionType"" = 1) AND (COALESCE(""w"".""IsAutomatic"", FALSE) = TRUE)
            ");
        }
        ...
        public override async Task Coalesce_operator_in_projection_with_other_conditions(bool isAsync)
        {
            ...
            AssertSql(@"
                SELECT CASE
                    WHEN ((""w"".""AmmunitionType"" = 1) AND ""w"".""AmmunitionType"" IS NOT NULL) AND (COALESCE(""w"".""IsAutomatic"", FALSE) = TRUE) THEN TRUE
                    ELSE FALSE
                END
                FROM ""Weapons"" AS ""w""
            ");
        ...
        public override async Task Optional_navigation_type_compensation_works_with_predicate(bool isAsync)
        {
            ...
            AssertSql(@"
                ...
                WHERE ((""t"".""Note"" <> N'K.I.A.') OR ""t"".""Note"" IS NULL) AND (""t0"".""HasSoulPatch"" = TRUE)
            ");
        }
        ...
        public override async Task Optional_navigation_type_compensation_works_with_binary_expression(bool isAsync)
        {
            ...
            AssertSql(@"
                ...
                WHERE (""t0"".""HasSoulPatch"" = TRUE) OR (CHARINDEX(N'Cole', ""t"".""Note"") > 0)
            ");
        }
        ...
        public override async Task Optional_navigation_type_compensation_works_with_binary_and_expression(bool isAsync)
        {
            ...
            AssertSql(@"
                SELECT CASE
                    WHEN (""t0"".""HasSoulPatch"" = TRUE) AND (CHARINDEX(N'Cole', ""t"".""Note"") > 0) THEN TRUE
                    ELSE FALSE
                END
                FROM ""Tags"" AS ""t""
                LEFT JOIN (
            ...
            AssertSql(@"
                SELECT CASE
                    WHEN NOT EXISTS (
                        ...
                        WHERE ((""t"".""Note"" <> N'K.I.A.') OR ""t"".""Note"" IS NULL) AND (""t0"".""HasSoulPatch"" <> TRUE)) THEN TRUE
                    ELSE FALSE
                END
            ");
        }
        ...
        public override async Task Optional_navigation_type_compensation_works_with_take(bool isAsync)
        {
            ...
            AssertSql(
                ...
                @"
                    ...
                    SELECT FIRST @_outer_SquadId ""g"".""Nickname"", ""g"".""SquadId"", ""g"".""AssignedCityName"", ""g"".""CityOfBirthName"", ""g"".""Discriminator"", ""g"".""FullName"", ""g"".""HasSoulPatch"", ""g"".""LeaderNickname"", ""g"".""LeaderSquadId"", ""g"".""Rank""
                    FROM ""Gears"" AS ""g""
                    WHERE ""g"".""Discriminator"" IN (N'Officer', N'Gear')
                    ORDER BY ""g"".""Nickname""
                ",
        ...
        public override async Task FirstOrDefault_with_manually_created_groupjoin_is_translated_to_sql(bool isAsync)
        {
            ...
            AssertSql(@"
                SELECT FIRST 1 ""s"".""Id"", ""s"".""InternalNumber"", ""s"".""Name""
                FROM ""Squads"" AS ""s""
                LEFT JOIN (
                    SELECT ""g"".""Nickname"", ""g"".""SquadId"", ""g"".""AssignedCityName"", ""g"".""CityOfBirthName"", ""g"".""Discriminator"", ""g"".""FullName"", ""g"".""HasSoulPatch"", ""g"".""LeaderNickname"", ""g"".""LeaderSquadId"", ""g"".""Rank""
                    FROM ""Gears"" AS ""g""
            ...
            AssertSql(@"
                SELECT CASE
                    WHEN NOT EXISTS (
                        ...
                        FROM ""Gears"" AS ""g""
                        LEFT JOIN ""Tags"" AS ""t"" ON (""g"".""Nickname"" = ""t"".""GearNickName"") AND (""g"".""SquadId"" = ""t"".""GearSquadId"")
                        WHERE ""g"".""Discriminator"" IN (N'Gear', N'Officer') AND ((""t"".""Note"" = N'Foo') AND ""t"".""Note"" IS NOT NULL)) THEN TRUE
                    ELSE FALSE
                END
            ");
        }
        ...
        public override async Task Where_is_properly_lifted_from_subquery_created_by_include(bool isAsync)
        {
            ...
            AssertSql(@"
                ...
                FROM ""Gears"" AS ""g""
                LEFT JOIN ""Tags"" AS ""t"" ON (""g"".""Nickname"" = ""t"".""GearNickName"") AND (""g"".""SquadId"" = ""t"".""GearSquadId"")
                WHERE (""g"".""Discriminator"" IN (N'Gear', N'Officer') AND (""g"".""FullName"" <> N'Augustus Cole')) AND (""g"".""HasSoulPatch"" <> TRUE)
                ORDER BY ""g"".""FullName""
            ");
        }
        ...
        public override async Task Subquery_is_lifted_from_main_from_clause_of_SelectMany(bool isAsync)
        {
            ...
            AssertSql(@"
                ...
                WHERE ""g"".""Discriminator"" IN (N'Gear', N'Officer') AND ((""g"".""HasSoulPatch"" = TRUE) AND (""t"".""HasSoulPatch"" <> TRUE))
                ORDER BY ""g"".""FullName""
            ");
        }
        ...
        public override async Task Subquery_with_result_operator_is_not_lifted(bool isAsync)
        {
            ...
            AssertSql(@"
                ...
                SELECT ""t"".""FullName""
                FROM (
                    SELECT FIRST @__p_0 ""g"".""Nickname"", ""g"".""SquadId"", ""g"".""AssignedCityName"", ""g"".""CityOfBirthName"", ""g"".""Discriminator"", ""g"".""FullName"", ""g"".""HasSoulPatch"", ""g"".""LeaderNickname"", ""g"".""LeaderSquadId"", ""g"".""Rank""
                    FROM ""Gears"" AS ""g""
                    WHERE ""g"".""Discriminator"" IN (N'Gear', N'Officer') AND (""g"".""HasSoulPatch"" <> TRUE)
                    ORDER BY ""g"".""FullName""
                ) AS ""t""
        ...
        public override Task Client_method_on_collection_navigation_in_predicate(bool isAsync)
        {
            return base.Client_method_on_collection_navigation_in_predicate(isAsync);
        }

        public override Task Client_method_on_collection_navigation_in_predicate_accessed_by_ef_property(bool isAsync)
        {
            return base.Client_method_on_collection_navigation_in_predicate_accessed_by_ef_property(isAsync);
        }

        public override Task Client_method_on_collection_navigation_in_order_by(bool isAsync)
        {
            return base.Client_method_on_collection_navigation_in_order_by(isAsync);
        }

        public override Task Client_method_on_collection_navigation_in_additional_from_clause(bool isAsync)
        {
            return base.Client_method_on_collection_navigation_in_additional_from_clause(isAsync);
        }
        ...
        [ActianTodo]
        public override Task Include_on_derived_entity_with_cast(bool isAsync)
        {
            return base.Include_on_derived_entity_with_cast(isAsync);
        }
        ...
        public override async Task Comparing_two_collection_navigations_inheritance(bool isAsync)
        {
            ...
            AssertSql(@"
                ...
                WHERE ((""f"".""Discriminator"" = N'LocustHorde') AND ((""f"".""Discriminator"" = N'LocustHorde') AND (""t"".""HasSoulPatch"" = TRUE))) AND ((""t1"".""Nickname"" = ""t"".""Nickname"") AND (""t1"".""SquadId"" = ""t"".""SquadId""))
            ");
        }
        ...
        public override Task Include_collection_and_invalid_navigation_using_string_throws(bool isAsync)
        {
            return base.Include_collection_and_invalid_navigation_using_string_throws(isAsync);
        }
        ...
        public override async Task Correlated_collections_basic_projection(bool isAsync)
        {
            ...
            AssertSql(@"
                ...
                LEFT JOIN (
                    SELECT ""w"".""Id"", ""w"".""AmmunitionType"", ""w"".""IsAutomatic"", ""w"".""Name"", ""w"".""OwnerFullName"", ""w"".""SynergyWithId""
                    FROM ""Weapons"" AS ""w""
                    WHERE (""w"".""IsAutomatic"" = TRUE) OR ((""w"".""Name"" <> N'foo') OR ""w"".""Name"" IS NULL)
                ) AS ""t"" ON ""g"".""FullName"" = ""t"".""OwnerFullName""
                WHERE ""g"".""Discriminator"" IN (N'Gear', N'Officer') AND (""g"".""Nickname"" <> N'Marcus')
        ...
        public override async Task Correlated_collections_basic_projection_composite_key(bool isAsync)
        {
            ...
            AssertSql(@"
                ...
                LEFT JOIN (
                    ...
                    FROM ""Gears"" AS ""g0""
                    WHERE ""g0"".""Discriminator"" IN (N'Gear', N'Officer') AND (""g0"".""HasSoulPatch"" <> TRUE)
                ) AS ""t"" ON (""g"".""Nickname"" = ""t"".""LeaderNickname"") AND (""g"".""SquadId"" = ""t"".""LeaderSquadId"")
        ...
        public override async Task Correlated_collections_with_Take(bool isAsync)
        {
            ...
            AssertSql(
                ...
                @"
                    ...
                    SELECT FIRST 2 ""g"".""Nickname"", ""g"".""SquadId"", ""g"".""AssignedCityName"", ""g"".""CityOfBirthName"", ""g"".""Discriminator"", ""g"".""FullName"", ""g"".""HasSoulPatch"", ""g"".""LeaderNickname"", ""g"".""LeaderSquadId"", ""g"".""Rank""
                    FROM ""Gears"" AS ""g""
                    WHERE ""g"".""Discriminator"" IN (N'Officer', N'Gear') AND (@_outer_Id = ""g"".""SquadId"")
                    ORDER BY ""g"".""Nickname""
                ",
        ...
        public override async Task Correlated_collection_with_top_level_FirstOrDefault(bool isAsync)
        {
            ...
            AssertSql(@"
                ...
                FROM (
                    SELECT FIRST 1 ""g"".""Nickname"", ""g"".""SquadId"", ""g"".""FullName""
                    FROM ""Gears"" AS ""g""
                    WHERE ""g"".""Discriminator"" IN (N'Gear', N'Officer')
                    ORDER BY ""g"".""Nickname""
                ) AS ""t""
        ...
        public override void Include_with_group_by_order_by_take()
        {
            ...
            AssertSql(
                ...
                @"
                    ...
                    FROM ""Weapons"" AS ""g.Weapons""
                    INNER JOIN (
                        SELECT FIRST @__p_0 ""g0"".""FullName"", ""g0"".""Nickname""
                        FROM ""Gears"" AS ""g0""
                        WHERE ""g0"".""Discriminator"" IN (N'Officer', N'Gear')
        ...
        public override async Task Null_semantics_on_nullable_bool_from_inner_join_subquery_is_fully_applied(bool isAsync)
        {
            ...
            AssertSql(@"
                ...
                WHERE ""l"".""Discriminator"" IN (N'LocustLeader', N'LocustCommander') AND ((""t"".""Eradicated"" <> TRUE) OR ""t"".""Eradicated"" IS NULL)
            ");
        }
        ...
        public override async Task Include_on_derived_type_with_order_by_and_paging(bool isAsync)
        {
            ...
            AssertSql(@"
                ...
                FROM (
                    SELECT FIRST @__p_0 ""l"".""Name"", ""l"".""Discriminator"", ""l"".""LocustHordeId"", ""l"".""ThreatLevel"", ""l"".""DefeatedByNickname"", ""l"".""DefeatedBySquadId"", ""l"".""HighCommandId"", ""t0"".""Note""
                    FROM ""LocustLeaders"" AS ""l""
                    LEFT JOIN (
                        SELECT ""g"".""Nickname"", ""g"".""SquadId"", ""g"".""AssignedCityName"", ""g"".""CityOfBirthName"", ""g"".""Discriminator"", ""g"".""FullName"", ""g"".""HasSoulPatch"", ""g"".""LeaderNickname"", ""g"".""LeaderSquadId"", ""g"".""Rank""
                        FROM ""Gears"" AS ""g""
        ...
        public override async Task Where_required_navigation_on_derived_type(bool isAsync)
        {
            ...
            AssertSql(@"
                ...
                FROM ""LocustLeaders"" AS ""l""
                LEFT JOIN ""LocustHighCommands"" AS ""l0"" ON ""l"".""HighCommandId"" = ""l0"".""Id""
                WHERE ""l"".""Discriminator"" IN (N'LocustLeader', N'LocustCommander') AND (""l0"".""IsOperational"" = TRUE)
            ");
        }
        ...
        public override Task Include_with_concat(bool isAsync)
        {
            return base.Include_with_concat(isAsync);
        }
        ...
        public override Task Join_with_complex_key_selector(bool isAsync)
        {
            return base.Join_with_complex_key_selector(isAsync);
        }
        ...
        public override void Include_with_group_by_on_entity_qsre()
        {
            ...
            AssertSql(
                ...
                ",
                @"
                    SELECT ""s.Members"".""Nickname"", ""s.Members"".""SquadId"", ""s.Members"".""AssignedCityName"", ""s.Members"".""CityOfBirthName"", ""s.Members"".""Discriminator"", ""s.Members"".""FullName"", ""s.Members"".""HasSoulPatch"", ""s.Members"".""LeaderNickname"", ""s.Members"".""LeaderSquadId"", ""s.Members"".""Rank""
        ...
        public override void Include_with_group_by_on_entity_navigation()
        {
            ...
            AssertSql(
                @"
                    SELECT ""g"".""Nickname"", ""g"".""SquadId"", ""g"".""AssignedCityName"", ""g"".""CityOfBirthName"", ""g"".""Discriminator"", ""g"".""FullName"", ""g"".""HasSoulPatch"", ""g"".""LeaderNickname"", ""g"".""LeaderSquadId"", ""g"".""Rank"", ""g.Squad"".""Id"", ""g.Squad"".""InternalNumber"", ""g.Squad"".""Name""
                    FROM ""Gears"" AS ""g""
        ...
        public override void Include_with_group_by_on_entity_navigation_with_inheritance()
        {
            ...
            AssertSql(
                @"
                    SELECT ""f"".""Id"", ""f"".""CapitalName"", ""f"".""Discriminator"", ""f"".""Name"", ""f"".""CommanderName"", ""f"".""Eradicated"", ""t0"".""Nickname"", ""t0"".""SquadId"", ""t0"".""AssignedCityName"", ""t0"".""CityOfBirthName"", ""t0"".""Discriminator"", ""t0"".""FullName"", ""t0"".""HasSoulPatch"", ""t0"".""LeaderNickname"", ""t0"".""LeaderSquadId"", ""t0"".""Rank""
                    FROM ""Factions"" AS ""f""
                    LEFT JOIN (
                        SELECT ""l.Commander"".*
        ...
        public override async Task Streaming_correlated_collection_issue_11403(bool isAsync)
        {
            ...
            AssertSql(
                ...
                @"
                    ...
                    SELECT ""w"".""Id"", ""w"".""AmmunitionType"", ""w"".""IsAutomatic"", ""w"".""Name"", ""w"".""OwnerFullName"", ""w"".""SynergyWithId""
                    FROM ""Weapons"" AS ""w""
                    WHERE (@_outer_FullName = ""w"".""OwnerFullName"") AND (""w"".""IsAutomatic"" = FALSE)
                    ORDER BY ""w"".""Id""
                "
            );
        }
        ...
        public override async Task Project_one_value_type_from_empty_collection(bool isAsync)
        {
            ...
            AssertSql(@"
                SELECT ""s"".""Name"", (
                    SELECT FIRST 1 ""g"".""SquadId""
                    FROM ""Gears"" AS ""g""
                    WHERE (""g"".""Discriminator"" IN (N'Gear', N'Officer') AND (""s"".""Id"" = ""g"".""SquadId"")) AND (""g"".""HasSoulPatch"" = TRUE)) AS ""SquadId""
                FROM ""Squads"" AS ""s""
                WHERE ""s"".""Name"" = N'Kilo'
            ");
        }
        ...
        public override async Task Filter_on_subquery_projecting_one_value_type_from_empty_collection(bool isAsync)
        {
            ...
            AssertSql(@"
                ...
                WHERE (""s"".""Name"" = N'Kilo') AND (COALESCE((
                    SELECT FIRST 1 ""g"".""SquadId""
                    FROM ""Gears"" AS ""g""
                    WHERE (""g"".""Discriminator"" IN (N'Officer', N'Gear') AND (""s"".""Id"" = ""g"".""SquadId"")) AND (""g"".""HasSoulPatch"" = TRUE)
                ), 0) <> 0)
            ");
        }
        ...
        public override async Task Select_subquery_projecting_single_constant_int(bool isAsync)
        {
            ...
            AssertSql(@"
                SELECT ""s"".""Name"", (
                    SELECT FIRST 1 42
                    FROM ""Gears"" AS ""g""
                    WHERE (""g"".""Discriminator"" IN (N'Gear', N'Officer') AND (""s"".""Id"" = ""g"".""SquadId"")) AND (""g"".""HasSoulPatch"" = TRUE)) AS ""Gear""
                FROM ""Squads"" AS ""s""
            ");
        }
        ...
        public override void GroupBy_composite_key_with_Include()
        {
            ...
            AssertSql(
                @"
                    SELECT ""o"".""Nickname"", ""o"".""SquadId"", ""o"".""AssignedCityName"", ""o"".""CityOfBirthName"", ""o"".""Discriminator"", ""o"".""FullName"", ""o"".""HasSoulPatch"", ""o"".""LeaderNickname"", ""o"".""LeaderSquadId"", ""o"".""Rank""
                    FROM ""Gears"" AS ""o""
            ...
            AssertSql(@"
                ...
                ORDER BY (
                    ...
                    WHERE (""g"".""FullName"" = ""w"".""OwnerFullName"") AND (""w"".""IsAutomatic"" = (
                        SELECT FIRST 1 ""g1"".""HasSoulPatch""
                        FROM ""Gears"" AS ""g1""
                        WHERE ""g1"".""Discriminator"" IN (N'Gear', N'Officer') AND (""g1"".""Nickname"" = N'Marcus')))), ""g"".""Nickname"", ""g"".""SquadId"", ""t"".""Nickname"", ""t"".""SquadId""
            ");
        }

        public override Task Cast_to_derived_type_causes_client_eval(bool isAsync)
        {
            return base.Cast_to_derived_type_causes_client_eval(isAsync);
        }
        ...
        public override async Task Double_order_by_on_Like(bool isAsync)
        {
            ...
            AssertSql(@"
                ...
                LEFT JOIN ""Weapons"" AS ""w0"" ON ""w"".""SynergyWithId"" = ""w0"".""Id""
                ORDER BY CASE
                    WHEN ""w0"".""Name"" LIKE N'%Lancer' THEN TRUE
                    ELSE FALSE
                END
            ");
        }
        ...
        public override async Task Double_order_by_on_is_null(bool isAsync)
        {
            ...
            AssertSql(@"
                ...
                LEFT JOIN ""Weapons"" AS ""w0"" ON ""w"".""SynergyWithId"" = ""w0"".""Id""
                ORDER BY CASE
                    WHEN ""w0"".""Name"" IS NULL THEN TRUE
                    ELSE FALSE
                END
            ");
        }
        ...
        [ActianTodo]
        public override async Task Null_semantics_is_correctly_applied_for_function_comparisons_that_take_arguments_from_optional_navigation_complex(bool isAsync)
        {
        ...
        [ActianTodo]
        public override Task Project_derivied_entity_with_convert_to_parent(bool isAsync)
        {
        ...
        public override async Task Navigation_inside_interpolated_string_expanded(bool isAsync)
        {
            ...
            AssertSql(@"
                SELECT CASE
                    WHEN ""w"".""SynergyWithId"" IS NOT NULL THEN TRUE
                    ELSE FALSE
        ...
        public override async Task Left_join_projection_using_conditional_tracking(bool isAsync)
        {
            ...
            AssertSql(@"
                SELECT CASE
                    WHEN ""t"".""Nickname"" IS NULL THEN TRUE
                    ELSE FALSE
        ...
        public override async Task Project_collection_navigation_nested_with_take_composite_key(bool isAsync)
        {
            ...
            AssertSql(@"
                ...
                OUTER APPLY (
                    SELECT FIRST 50 ""g0"".""Nickname"", ""g0"".""SquadId"", ""g0"".""AssignedCityName"", ""g0"".""CityOfBirthName"", ""g0"".""Discriminator"", ""g0"".""FullName"", ""g0"".""HasSoulPatch"", ""g0"".""LeaderNickname"", ""g0"".""LeaderSquadId"", ""g0"".""Rank""
                    FROM ""Gears"" AS ""g0""
        ...
        public override async Task Select_datetimeoffset_comparison_in_projection(bool isAsync)
        {
            ...
            AssertSql(@"
                SELECT CASE
                    WHEN ""m"".""Timeline"" > SYSDATETIMEOFFSET() THEN TRUE
                    ELSE FALSE
                END
                FROM ""Missions"" AS ""m""
            ");
        ...
        public override async Task Nullable_bool_comparison_is_translated_to_server(bool isAsync)
        {
            ...
            AssertSql(@"
                SELECT CASE
                    WHEN (""f"".""Eradicated"" = TRUE) AND ""f"".""Eradicated"" IS NOT NULL THEN TRUE
                    ELSE FALSE
                END AS ""IsEradicated""
                FROM ""Factions"" AS ""f""
                WHERE ""f"".""Discriminator"" = N'LocustHorde'
        ...
        public override async Task Accessing_property_of_optional_navigation_in_child_projection_works(bool isAsync)
        {
            ...
            AssertSql(@"
                SELECT CASE
                    WHEN ""t0"".""Nickname"" IS NOT NULL THEN TRUE
                    ELSE FALSE
        ...
        public override Task Include_after_select_with_cast_throws(bool isAsync)
        {
            return base.Include_after_select_with_cast_throws(isAsync);
        }

        public override Task Include_after_select_with_entity_projection_throws(bool isAsync)
        {
            return base.Include_after_select_with_entity_projection_throws(isAsync);
        }

        public override Task Include_after_select_anonymous_projection_throws(bool isAsync)
        {
            return base.Include_after_select_anonymous_projection_throws(isAsync);
        }

        public override Task Include_after_Select_throws(bool isAsync)
        {
            return base.Include_after_Select_throws(isAsync);
        }

        public override Task Include_after_SelectMany_throws(bool isAsync)
        {
            return base.Include_after_SelectMany_throws(isAsync);
        }
        ...
        public override async Task GroupBy_with_boolean_grouping_key(bool isAsync)
        {
            ...
            AssertSql(@"
                SELECT ""g"".""CityOfBirthName"", ""g"".""HasSoulPatch"", CASE
                    WHEN ""g"".""Nickname"" = N'Marcus' THEN TRUE
                    ELSE FALSE
        ...
        public override Task Group_by_with_aggregate_max_on_entity_type(bool isAsync)
        {
            return base.Group_by_with_aggregate_max_on_entity_type(isAsync);
        }
        ...
        public override async Task Where_null_parameter_is_not_null(bool isAsync)
        {
            ...
            AssertSql(@"
                ...
                SELECT ""g"".""Nickname"", ""g"".""SquadId"", ""g"".""AssignedCityName"", ""g"".""CityOfBirthName"", ""g"".""Discriminator"", ""g"".""FullName"", ""g"".""HasSoulPatch"", ""g"".""LeaderNickname"", ""g"".""LeaderSquadId"", ""g"".""Rank""
                FROM ""Gears"" AS ""g""
                WHERE ""g"".""Discriminator"" IN (N'Gear', N'Officer') AND (@__p_0 = TRUE)
            ");
        }
        ...
        public override async Task Where_with_enum_flags_parameter(bool isAsync)
        {
            ...
            AssertSql(
                ...
                @"
                    ...
                    SELECT ""g"".""Nickname"", ""g"".""SquadId"", ""g"".""AssignedCityName"", ""g"".""CityOfBirthName"", ""g"".""Discriminator"", ""g"".""FullName"", ""g"".""HasSoulPatch"", ""g"".""LeaderNickname"", ""g"".""LeaderSquadId"", ""g"".""Rank""
                    FROM ""Gears"" AS ""g""
                    WHERE ""g"".""Discriminator"" IN (N'Gear', N'Officer') AND ""g"".""Rank"" & @__rank_0 IS NULL
                ",
                @"
                    ...
                    SELECT ""g"".""Nickname"", ""g"".""SquadId"", ""g"".""AssignedCityName"", ""g"".""CityOfBirthName"", ""g"".""Discriminator"", ""g"".""FullName"", ""g"".""HasSoulPatch"", ""g"".""LeaderNickname"", ""g"".""LeaderSquadId"", ""g"".""Rank""
                    FROM ""Gears"" AS ""g""
                    WHERE ""g"".""Discriminator"" IN (N'Gear', N'Officer') AND (((""g"".""Rank"" | @__rank_0) <> @__rank_0) OR ""g"".""Rank"" | @__rank_0 IS NULL)
                ",
                @"
                    @__rank_0=NULL (DbType = Int32)
                    ...
                    SELECT ""g"".""Nickname"", ""g"".""SquadId"", ""g"".""AssignedCityName"", ""g"".""CityOfBirthName"", ""g"".""Discriminator"", ""g"".""FullName"", ""g"".""HasSoulPatch"", ""g"".""LeaderNickname"", ""g"".""LeaderSquadId"", ""g"".""Rank""
                    FROM ""Gears"" AS ""g""
                    WHERE ""g"".""Discriminator"" IN (N'Gear', N'Officer') AND ""g"".""Rank"" | @__rank_0 IS NOT NULL
                "
            );
        }
        ...
        public override async Task Conditional_expression_with_test_being_simplified_to_constant_simple(bool isAsync)
        {
            ...
            AssertSql(@"
                ...
                FROM ""Gears"" AS ""g""
                WHERE ""g"".""Discriminator"" IN (N'Gear', N'Officer') AND (CASE
                    WHEN ""g"".""HasSoulPatch"" = @__prm_0 THEN TRUE
                    ELSE CASE
                ...
                WHERE ""g"".""Discriminator"" IN (N'Gear', N'Officer') AND (CASE
                    WHEN ""g"".""HasSoulPatch"" = @__prm_0 THEN CASE
                        WHEN ((
                            ...
                            SELECT FIRST 1 ""w"".""Name""
                            FROM ""Weapons"" AS ""w""
                            WHERE ""w"".""Id"" = ""g"".""SquadId"") IS NOT NULL THEN TRUE
                        ELSE FALSE
                    END
                    ELSE CASE
                        WHEN FALSE = TRUE THEN TRUE
        ...
        public override async Task Constant_enum_with_same_underlying_value_as_previously_parameterized_int(bool async)
        {
            ...
            AssertSql(@"
                ...
                SELECT FIRST @__p_0 ""g"".""Rank"" & @__p_0
                FROM ""Gears"" AS ""g""
                WHERE ""g"".""Discriminator"" IN (N'Gear', N'Officer')
                ORDER BY ""g"".""Nickname""
            ");
