...
public class NorthwindAsTrackingQueryActianTest : NorthwindAsTrackingQueryTestBase<
    NorthwindQueryActianFixture<NoopModelCustomizer>>
{
    public NorthwindAsTrackingQueryActianTest(NorthwindQueryActianFixture<NoopModelCustomizer> fixture)
        : base(fixture)
    {
