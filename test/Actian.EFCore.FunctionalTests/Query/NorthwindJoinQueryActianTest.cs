...
public class NorthwindJoinQueryActianTest : NorthwindJoinQueryRelationalTestBase<NorthwindQueryActianFixture<NoopModelCustomizer>>
{
    public NorthwindJoinQueryActianTest(
