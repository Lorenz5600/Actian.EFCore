...
public class NorthwindStringIncludeQueryActianTest : NorthwindStringIncludeQueryTestBase<
    NorthwindQueryActianFixture<NoopModelCustomizer>>
{
    public NorthwindStringIncludeQueryActianTest(NorthwindQueryActianFixture<NoopModelCustomizer> fixture)
        : base(fixture)
    {
