...
namespace Actian.EFCore.Query
{
    partial class SimpleQueryActianTest
    {
        ...
        public override async Task KeylessEntity_simple(bool isAsync)
        {
            ...
            AssertSql(@"SELECT ""c"".""CustomerID"" + N'' as ""CustomerID"", ""c"".""Address"", ""c"".""City"", ""c"".""CompanyName"", ""c"".""ContactName"", ""c"".""ContactTitle"", ""c"".""Country"", ""c"".""Fax"", ""c"".""Phone"", ""c"".""PostalCode"", ""c"".""Region"" FROM ""Customers"" AS ""c""");
        }
