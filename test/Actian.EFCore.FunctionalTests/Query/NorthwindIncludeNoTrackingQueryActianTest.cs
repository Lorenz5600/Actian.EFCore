...
public class NorthwindIncludeNoTrackingQueryActianTest : NorthwindIncludeNoTrackingQueryTestBase<
    NorthwindQueryActianFixture<NoopModelCustomizer>>
{
    public NorthwindIncludeNoTrackingQueryActianTest(NorthwindQueryActianFixture<NoopModelCustomizer> fixture)
        : base(fixture)
    {
