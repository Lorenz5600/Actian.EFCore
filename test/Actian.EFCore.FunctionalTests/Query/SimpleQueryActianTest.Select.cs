...
namespace Actian.EFCore.Query
{
    ...
    {
        public override Task Select_into(bool isAsync)
        {
            return base.Select_into(isAsync);
        }
        ...
        public override Task Select_bool_closure(bool isAsync)
        {
            return base.Select_bool_closure(isAsync);
        }
        ...
        public override Task Select_customer_table(bool isAsync)
        {
            return base.Select_customer_table(isAsync);
        }
        
        public override Task Select_customer_identity(bool isAsync)
        {
            return base.Select_customer_identity(isAsync);
        }
        
        [ActianTodo]
        public override Task Select_anonymous_with_object(bool isAsync)
        {
            return base.Select_anonymous_with_object(isAsync);
        }
        
        [ActianTodo]
        public override Task Select_anonymous_nested(bool isAsync)
        {
            return base.Select_anonymous_nested(isAsync);
        }
        
        public override Task Select_anonymous_empty(bool isAsync)
        {
            return base.Select_anonymous_empty(isAsync);
        }
        
        public override Task Select_anonymous_literal(bool isAsync)
        {
            return base.Select_anonymous_literal(isAsync);
        }
        ...
        public override Task Select_scalar_primitive(bool isAsync)
        {
            return base.Select_scalar_primitive(isAsync);
        }
        ...
        public override void Select_nested_collection_multi_level()
        {
            ...
            AssertSql(@"
                ...
                FROM ""Customers"" AS ""c""
                OUTER APPLY (
                    SELECT FIRST 3 ""o"".""OrderDate"", ""o"".""OrderID""
                    FROM ""Orders"" AS ""o""
        ...
        [ActianTodo]
        public override Task Select_nested_collection_deep(bool isAsync)
        {
            return base.Select_nested_collection_deep(isAsync);
        }
        ...
        public override async Task Project_single_element_from_collection_with_OrderBy_Take_and_FirstOrDefault(bool isAsync)
        {
            ...
            AssertSql(@"
                SELECT (
                    SELECT FIRST 1 ""t"".""CustomerID""
                    FROM (
                        SELECT FIRST 1 ""o"".""CustomerID"", ""o"".""OrderID""
                        FROM ""Orders"" AS ""o""
        ...
        public override async Task Project_single_element_from_collection_with_OrderBy_Distinct_and_FirstOrDefault(bool isAsync)
        {
            ...
            AssertSql(@"
                SELECT (
                    SELECT DISTINCT FIRST 1 ""o"".""CustomerID""
                    FROM ""Orders"" AS ""o""
                    WHERE ""c"".""CustomerID"" = ""o"".""CustomerID"")
                FROM ""Customers"" AS ""c""
            ");
        ...
        public override async Task Project_single_element_from_collection_with_OrderBy_Distinct_and_FirstOrDefault_followed_by_projecting_length(bool isAsync)
        {
            ...
            AssertSql(@"
                SELECT (
                    SELECT FIRST 1 CAST(LEN(""t"".""CustomerID"") AS int)
                    FROM (
        ...
        public override async Task Project_single_element_from_collection_with_OrderBy_Take_and_FirstOrDefault_with_parameter(bool isAsync)
        {
            ...
            AssertSql(@"
                ...
                SELECT (
                    SELECT FIRST 1 ""t"".""CustomerID""
                    FROM (
                        SELECT FIRST @__i_0 ""o"".""CustomerID"", ""o"".""OrderID""
                        FROM ""Orders"" AS ""o""
                        WHERE ""c"".""CustomerID"" = ""o"".""CustomerID""
                        ORDER BY ""o"".""OrderID""
                    ) AS ""t""
        ...
        public override async Task Project_single_element_from_collection_with_multiple_OrderBys_Take_and_FirstOrDefault(bool isAsync)
        {
            ...
            AssertSql(@"
                SELECT (
                    SELECT FIRST 1 ""t"".""CustomerID""
                    FROM (
                        SELECT FIRST 2 ""o"".""CustomerID"", ""o"".""OrderID"", ""o"".""OrderDate""
                        FROM ""Orders"" AS ""o""
                        WHERE ""c"".""CustomerID"" = ""o"".""CustomerID""
        ...
        public override async Task Project_single_element_from_collection_with_OrderBy_over_navigation_Take_and_FirstOrDefault(bool isAsync)
        {
            ...
            AssertSql(@"
                SELECT (
                    SELECT FIRST 1 ""t"".""OrderID""
                    FROM (
                        SELECT FIRST 1 ""o"".""OrderID"", ""o"".""ProductID"", ""p"".""ProductID"" AS ""ProductID0"", ""p"".""ProductName""
                        FROM ""Order Details"" AS ""o""
            ...
            bool isAsync)
        {
            ...
            AssertSql(@"
                ...
                FROM ""Orders"" AS ""o""
                OUTER APPLY (
                    SELECT FIRST 1 ""t"".""OrderID"", ""t"".""ProductID"", ""t"".""Discount"", ""t"".""Quantity"", ""t"".""UnitPrice"", ""t"".""ProductID0"", ""t"".""ProductName""
                    FROM (
                        SELECT FIRST 1 ""o0"".""OrderID"", ""o0"".""ProductID"", ""o0"".""Discount"", ""o0"".""Quantity"", ""o0"".""UnitPrice"", ""p"".""ProductID"" AS ""ProductID0"", ""p"".""ProductName""
        ...
        public override Task Select_datetime_DayOfWeek_component(bool isAsync)
        {
            return base.Select_datetime_DayOfWeek_component(isAsync);
        }
        
        public override Task Select_datetime_Ticks_component(bool isAsync)
        {
            return base.Select_datetime_Ticks_component(isAsync);
        }
        
        public override Task Select_datetime_TimeOfDay_component(bool isAsync)
        {
            return base.Select_datetime_TimeOfDay_component(isAsync);
        }
        ...
        public override async Task Projecting_nullable_struct(bool isAsync)
        {
            ...
            AssertSql(@"
                SELECT ""o"".""CustomerID"", CASE
                    WHEN (""o"".""CustomerID"" = N'ALFKI') AND ""o"".""CustomerID"" IS NOT NULL THEN TRUE
                    ELSE FALSE
                END, ""o"".""OrderID"", CAST(LENGTH(""o"".""CustomerID"") AS int)
                FROM ""Orders"" AS ""o""
            ");
        }
        ...
        public override async Task Multiple_select_many_with_predicate(bool isAsync)
        {
            ...
            AssertSql(@"
                ...
                WHERE CAST(""o0"".""Discount"" AS float) >= 0.25
            ");
        }
        ...
        public override async Task SelectMany_correlated_with_outer_2(bool isAsync)
        {
            ...
            AssertSql(@"
                ...
                FROM ""Customers"" AS ""c""
                CROSS APPLY (
                    SELECT FIRST 2 ""o"".""OrderID"", ""o"".""CustomerID"", ""o"".""EmployeeID"", ""o"".""OrderDate"", ""c"".""City""
                    FROM ""Orders"" AS ""o""
                    WHERE ""c"".""CustomerID"" = ""o"".""CustomerID""
        ...
        public override async Task Select_entity_compared_to_null(bool isAsync)
        {
            ...
            AssertSql(@"
                SELECT CASE
                    WHEN ""c"".""CustomerID"" IS NULL THEN TRUE
                    ELSE FALSE
                END
                FROM ""Orders"" AS ""o""
                LEFT JOIN ""Customers"" AS ""c"" ON ""o"".""CustomerID"" = ""c"".""CustomerID""
        ...
        {
            return base.Projection_with_parameterized_constructor(async);
        }
        
        public override Task Projection_with_parameterized_constructor_with_member_assignment(bool async)
        {
            return base.Projection_with_parameterized_constructor_with_member_assignment(async);
        }
