...
namespace Actian.EFCore.Query
{
    partial class SimpleQueryActianTest
    {
            ...
            AssertSql(@"
                SELECT CASE
                    WHEN NOT EXISTS (
                        SELECT 1
                        FROM ""Orders"" AS ""o""
                        WHERE (""o"".""CustomerID"" <> N'ALFKI') OR ""o"".""CustomerID"" IS NULL) THEN TRUE
                    ELSE FALSE
                END
            ");
        }
        ...
        [ActianTodo]
        public override void GroupBy_tracking_after_dispose()
        {
            base.GroupBy_tracking_after_dispose();
        }
        ...
        public override async Task Sum_on_float_column(bool isAsync)
        {
            ...
            AssertSql(@"
                SELECT CAST(SUM(""o"".""Discount"") AS float4)
                FROM ""Order Details"" AS ""o""
                WHERE ""o"".""ProductID"" = 1
            ");
        }
        ...
        public override async Task Average_on_float_column(bool isAsync)
        {
            ...
            AssertSql(@"
                SELECT CAST(AVG(""o"".""Discount"") AS float4)
                FROM ""Order Details"" AS ""o""
                WHERE ""o"".""ProductID"" = 1
            ");
        }
        ...
        public override Task Where_OrderBy_Count_client_eval(bool isAsync)
        {
            return base.Where_OrderBy_Count_client_eval(isAsync);
        }
        
        public override Task OrderBy_Where_Count_client_eval(bool isAsync)
        {
            return base.OrderBy_Where_Count_client_eval(isAsync);
        }
        
        public override Task OrderBy_Where_Count_client_eval_mixed(bool isAsync)
        {
            return base.OrderBy_Where_Count_client_eval_mixed(isAsync);
        }
        
        public override Task OrderBy_Count_with_predicate_client_eval(bool isAsync)
        {
            return base.OrderBy_Count_with_predicate_client_eval(isAsync);
        }
        
        public override Task OrderBy_Count_with_predicate_client_eval_mixed(bool isAsync)
        {
            return base.OrderBy_Count_with_predicate_client_eval_mixed(isAsync);
        }
        
        public override Task OrderBy_Where_Count_with_predicate_client_eval(bool isAsync)
        {
            return base.OrderBy_Where_Count_with_predicate_client_eval(isAsync);
        }
        
        public override Task OrderBy_Where_Count_with_predicate_client_eval_mixed(bool isAsync)
        {
            return base.OrderBy_Where_Count_with_predicate_client_eval_mixed(isAsync);
        }
        
        [ActianTodo]
        public override Task OrderBy_client_Take(bool isAsync)
        {
            return base.OrderBy_client_Take(isAsync);
        }
        ...
        public override Task Single_Throws(bool isAsync)
        {
            return base.Single_Throws(isAsync);
        }
        ...
        public override Task Where_Single(bool isAsync)
        {
            return base.Where_Single(isAsync);
        }
        
        public override Task SingleOrDefault_Throws(bool isAsync)
        {
            return base.SingleOrDefault_Throws(isAsync);
        }
        
        public override Task SingleOrDefault_Predicate(bool isAsync)
        {
            return base.SingleOrDefault_Predicate(isAsync);
        }
        
        public override Task Where_SingleOrDefault(bool isAsync)
        {
            return base.Where_SingleOrDefault(isAsync);
        }
        
        public override Task First(bool isAsync)
        {
            return base.First(isAsync);
        }
        
        public override Task First_Predicate(bool isAsync)
        {
            return base.First_Predicate(isAsync);
        }
        
        public override Task Where_First(bool isAsync)
        {
            return base.Where_First(isAsync);
        }
        
        public override Task FirstOrDefault(bool isAsync)
        {
            return base.FirstOrDefault(isAsync);
        }
        
        public override Task FirstOrDefault_Predicate(bool isAsync)
        {
            return base.FirstOrDefault_Predicate(isAsync);
        }
        
        public override Task Where_FirstOrDefault(bool isAsync)
        {
            return base.Where_FirstOrDefault(isAsync);
        }
        ...
        public override async Task Multiple_collection_navigation_with_FirstOrDefault_chained(bool isAsync)
        {
            ...
            AssertSql(
                ...
                @"
                    ...
                    SELECT FIRST 1 ""od"".""OrderID"", ""od"".""ProductID"", ""od"".""Discount"", ""od"".""Quantity"", ""od"".""UnitPrice""
        ...
        public override async Task OrderBy_Take_Last_gives_correct_result(bool isAsync)
        {
            ...
            AssertSql(@"
                ...
                SELECT FIRST 1 ""t"".""CustomerID"", ""t"".""Address"", ""t"".""City"", ""t"".""CompanyName"", ""t"".""ContactName"", ""t"".""ContactTitle"", ""t"".""Country"", ""t"".""Fax"", ""t"".""Phone"", ""t"".""PostalCode"", ""t"".""Region""
                FROM (
        ...
        [ActianTodo]
        public override Task Array_cast_to_IEnumerable_Contains_with_constant(bool isAsync)
        {
            return base.Array_cast_to_IEnumerable_Contains_with_constant(isAsync);
        }
        ...
        public override Task Sum_over_empty_returns_zero(bool isAsync)
        {
            return base.Sum_over_empty_returns_zero(isAsync);
        }
        
        public override Task Average_over_default_returns_default(bool isAsync)
        {
            return base.Average_over_default_returns_default(isAsync);
        }
        
        public override Task Max_over_default_returns_default(bool isAsync)
        {
            return base.Max_over_default_returns_default(isAsync);
        }
        
        public override Task Min_over_default_returns_default(bool isAsync)
        {
            return base.Min_over_default_returns_default(isAsync);
        }
    }
}
