...
namespace Actian.EFCore
{
    ...
    {
        public ConvertToProviderTypesActianTest(ConvertToProviderTypesActianFixture fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
        ...
        public class ConvertToProviderTypesActianFixture : ConvertToProviderTypesFixtureBase
        {
            ...
            protected override void OnModelCreating(ModelBuilder modelBuilder, DbContext context)
            {
                ...
                ActianModelTestHelpers.MaxLengthBinaryKeys
                    .Normalize(modelBuilder);
